...
public class TTestCaseData implements org.apache.thrift.TBase<TTestCaseData, TTestCaseData._Fields>, java.io.Serializable, Cloneable, Comparable<TTestCaseData> {
  ...
  public String query_stmt; // required
  public List<org.apache.impala.thrift.TTable> tables_and_views; // optional
  public List<org.apache.impala.thrift.TDatabase> dbs; // optional
  public String testcase_data_path; // required
  public String impala_version; // required
  ...
  public TTestCaseData setQuery_stmt(String query_stmt) {
    this.query_stmt = query_stmt;
    return this;
  }
  ...
  public TTestCaseData setTables_and_views(List<org.apache.impala.thrift.TTable> tables_and_views) {
  ...
  public TTestCaseData setDbs(List<org.apache.impala.thrift.TDatabase> dbs) {
    this.dbs = dbs;
    return this;
  }
  ...
  public TTestCaseData setTestcase_data_path(String testcase_data_path) {
    this.testcase_data_path = testcase_data_path;
    return this;
  }
  ...
  public TTestCaseData setImpala_version(String impala_version) {
    this.impala_version = impala_version;
    return this;
  }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (query_stmt == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'query_stmt' was not present! Struct: " + toString());
    }
    if (testcase_data_path == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'testcase_data_path' was not present! Struct: " + toString());
    }
    if (impala_version == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'impala_version' was not present! Struct: " + toString());
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.tables_and_views = new ArrayList<org.apache.impala.thrift.TTable>(_list242.size);
                org.apache.impala.thrift.TTable _elem243;
                for (int _i244 = 0; _i244 < _list242.size; ++_i244)
                {
                  _elem243 = new org.apache.impala.thrift.TTable();
                  _elem243.read(iprot);
                  struct.tables_and_views.add(_elem243);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.dbs = new ArrayList<org.apache.impala.thrift.TDatabase>(_list245.size);
                org.apache.impala.thrift.TDatabase _elem246;
                for (int _i247 = 0; _i247 < _list245.size; ++_i247)
                {
                  _elem246 = new org.apache.impala.thrift.TDatabase();
                  _elem246.read(iprot);
                  struct.dbs.add(_elem246);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.tables_and_views != null) {
        if (struct.isSetTables_and_views()) {
          oprot.writeFieldBegin(TABLES_AND_VIEWS_FIELD_DESC);
          {
            ...
            for (org.apache.impala.thrift.TTable _iter248 : struct.tables_and_views)
            {
      ...
      if (struct.dbs != null) {
        if (struct.isSetDbs()) {
          oprot.writeFieldBegin(DBS_FIELD_DESC);
          {
            ...
            for (org.apache.impala.thrift.TDatabase _iter249 : struct.dbs)
            {
      ...
      if (struct.isSetTables_and_views()) {
        {
          ...
          for (org.apache.impala.thrift.TTable _iter250 : struct.tables_and_views)
          {
      ...
      if (struct.isSetDbs()) {
        {
          ...
          for (org.apache.impala.thrift.TDatabase _iter251 : struct.dbs)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.tables_and_views = new ArrayList<org.apache.impala.thrift.TTable>(_list252.size);
          org.apache.impala.thrift.TTable _elem253;
          for (int _i254 = 0; _i254 < _list252.size; ++_i254)
          {
            _elem253 = new org.apache.impala.thrift.TTable();
            _elem253.read(iprot);
            struct.tables_and_views.add(_elem253);
          }
        }
        struct.setTables_and_viewsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.dbs = new ArrayList<org.apache.impala.thrift.TDatabase>(_list255.size);
          org.apache.impala.thrift.TDatabase _elem256;
          for (int _i257 = 0; _i257 < _list255.size; ++_i257)
          {
            _elem256 = new org.apache.impala.thrift.TDatabase();
            _elem256.read(iprot);
            struct.dbs.add(_elem256);
          }
        }
        struct.setDbsIsSet(true);
      }
