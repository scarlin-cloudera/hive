...
public class TQueryExecRequest implements org.apache.thrift.TBase<TQueryExecRequest, TQueryExecRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TQueryExecRequest> {
  ...
  private List<TPlanExecInfo> plan_exec_info; // optional
  private org.apache.impala.thrift.TResultSetMetadata result_set_metadata; // optional
  private TFinalizeParams finalize_params; // optional
  private org.apache.impala.thrift.TQueryCtx query_ctx; // required
  private String query_plan; // optional
  private org.apache.impala.thrift.TStmtType stmt_type; // required
  private List<org.apache.impala.thrift.TNetworkAddress> host_list; // required
  private org.apache.impala.thrift.TLineageGraph lineage_graph; // optional
  private long per_host_mem_estimate; // optional
  private long max_per_host_min_mem_reservation; // optional
  private long max_per_host_thread_reservation; // optional
  private long dedicated_coord_mem_estimate; // optional
  ...
  static {
    ...
    tmpMap.put(_Fields.QUERY_CTX, new org.apache.thrift.meta_data.FieldMetaData("query_ctx", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, org.apache.impala.thrift.TQueryCtx.class)));
  ...
  public TQueryExecRequest(
    org.apache.impala.thrift.TQueryCtx query_ctx,
  ...
  public TQueryExecRequest(TQueryExecRequest other) {
    ...
    if (other.isSetQuery_ctx()) {
      this.query_ctx = new org.apache.impala.thrift.TQueryCtx(other.query_ctx);
    }
  ...
  public void setPlan_exec_info(List<TPlanExecInfo> plan_exec_info) {
  ...
  public void setFinalize_params(TFinalizeParams finalize_params) {
  ...
  public org.apache.impala.thrift.TQueryCtx getQuery_ctx() {
    return this.query_ctx;
  }

  public void setQuery_ctx(org.apache.impala.thrift.TQueryCtx query_ctx) {
    this.query_ctx = query_ctx;
  }
  ...
  public void setHost_list(List<org.apache.impala.thrift.TNetworkAddress> host_list) {
    this.host_list = host_list;
  }
  ...
  public void setLineage_graph(org.apache.impala.thrift.TLineageGraph lineage_graph) {
  ...
  public void setPer_host_mem_estimate(long per_host_mem_estimate) {
  ...
  public void setMax_per_host_min_mem_reservation(long max_per_host_min_mem_reservation) {
  ...
  public void setMax_per_host_thread_reservation(long max_per_host_thread_reservation) {
  ...
  public void setDedicated_coord_mem_estimate(long dedicated_coord_mem_estimate) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case QUERY_CTX:
      if (value == null) {
        ...
        setQuery_ctx((org.apache.impala.thrift.TQueryCtx)value);
      }
      break;
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (!isSetQuery_ctx()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'query_ctx' is unset! Struct:" + toString());
    }
    ...
    if (!isSetHost_list()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'host_list' is unset! Struct:" + toString());
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TQueryExecRequest struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.plan_exec_info = new ArrayList<TPlanExecInfo>(_list154.size);
                TPlanExecInfo _elem155;
                for (int _i156 = 0; _i156 < _list154.size; ++_i156)
                {
                  _elem155 = new TPlanExecInfo();
                  _elem155.read(iprot);
                  struct.plan_exec_info.add(_elem155);
                }
                iprot.readListEnd();
              }
          ...
          case 4: // QUERY_CTX
            if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
              struct.query_ctx = new org.apache.impala.thrift.TQueryCtx();
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.host_list = new ArrayList<org.apache.impala.thrift.TNetworkAddress>(_list157.size);
                org.apache.impala.thrift.TNetworkAddress _elem158;
                for (int _i159 = 0; _i159 < _list157.size; ++_i159)
                {
                  _elem158 = new org.apache.impala.thrift.TNetworkAddress();
                  _elem158.read(iprot);
                  struct.host_list.add(_elem158);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TQueryExecRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.plan_exec_info != null) {
        if (struct.isSetPlan_exec_info()) {
          oprot.writeFieldBegin(PLAN_EXEC_INFO_FIELD_DESC);
          {
            ...
            for (TPlanExecInfo _iter160 : struct.plan_exec_info)
            {
      ...
      if (struct.host_list != null) {
        oprot.writeFieldBegin(HOST_LIST_FIELD_DESC);
        {
          ...
          for (org.apache.impala.thrift.TNetworkAddress _iter161 : struct.host_list)
          {
  ...
  private static class TQueryExecRequestTupleScheme extends TupleScheme<TQueryExecRequest> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TQueryExecRequest struct) throws org.apache.thrift.TException {
      ...
      oprot.writeI32(struct.stmt_type.getValue());
      {
        ...
        for (org.apache.impala.thrift.TNetworkAddress _iter162 : struct.host_list)
        {
      ...
      if (struct.isSetPlan_exec_info()) {
        {
          ...
          for (TPlanExecInfo _iter163 : struct.plan_exec_info)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TQueryExecRequest struct) throws org.apache.thrift.TException {
      ...
      struct.setStmt_typeIsSet(true);
      {
        ...
        struct.host_list = new ArrayList<org.apache.impala.thrift.TNetworkAddress>(_list164.size);
        org.apache.impala.thrift.TNetworkAddress _elem165;
        for (int _i166 = 0; _i166 < _list164.size; ++_i166)
        {
          _elem165 = new org.apache.impala.thrift.TNetworkAddress();
          _elem165.read(iprot);
          struct.host_list.add(_elem165);
        }
      }
      struct.setHost_listIsSet(true);
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.plan_exec_info = new ArrayList<TPlanExecInfo>(_list167.size);
          TPlanExecInfo _elem168;
          for (int _i169 = 0; _i169 < _list167.size; ++_i169)
          {
            _elem168 = new TPlanExecInfo();
            _elem168.read(iprot);
            struct.plan_exec_info.add(_elem168);
          }
        }
        struct.setPlan_exec_infoIsSet(true);
      }
