...
public class TExecQueryFInstancesSidecar implements org.apache.thrift.TBase<TExecQueryFInstancesSidecar, TExecQueryFInstancesSidecar._Fields>, java.io.Serializable, Cloneable, Comparable<TExecQueryFInstancesSidecar> {
  ...
  public org.apache.impala.thrift.TQueryCtx query_ctx; // optional
  public List<TPlanFragmentCtx> fragment_ctxs; // optional
  public List<TPlanFragmentInstanceCtx> fragment_instance_ctxs; // optional
  ...
  public TExecQueryFInstancesSidecar setQuery_ctx(org.apache.impala.thrift.TQueryCtx query_ctx) {
  ...
  public TExecQueryFInstancesSidecar setFragment_ctxs(List<TPlanFragmentCtx> fragment_ctxs) {
  ...
  public TExecQueryFInstancesSidecar setFragment_instance_ctxs(List<TPlanFragmentInstanceCtx> fragment_instance_ctxs) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.fragment_ctxs = new ArrayList<TPlanFragmentCtx>(_list44.size);
                TPlanFragmentCtx _elem45;
                for (int _i46 = 0; _i46 < _list44.size; ++_i46)
                {
                  _elem45 = new TPlanFragmentCtx();
                  _elem45.read(iprot);
                  struct.fragment_ctxs.add(_elem45);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.fragment_instance_ctxs = new ArrayList<TPlanFragmentInstanceCtx>(_list47.size);
                TPlanFragmentInstanceCtx _elem48;
                for (int _i49 = 0; _i49 < _list47.size; ++_i49)
                {
                  _elem48 = new TPlanFragmentInstanceCtx();
                  _elem48.read(iprot);
                  struct.fragment_instance_ctxs.add(_elem48);
                }
                iprot.readListEnd();
              }
      ...
      if (struct.fragment_ctxs != null) {
        if (struct.isSetFragment_ctxs()) {
          oprot.writeFieldBegin(FRAGMENT_CTXS_FIELD_DESC);
          {
            ...
            for (TPlanFragmentCtx _iter50 : struct.fragment_ctxs)
            {
              _iter50.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.fragment_instance_ctxs != null) {
        if (struct.isSetFragment_instance_ctxs()) {
          oprot.writeFieldBegin(FRAGMENT_INSTANCE_CTXS_FIELD_DESC);
          {
            ...
            for (TPlanFragmentInstanceCtx _iter51 : struct.fragment_instance_ctxs)
            {
              _iter51.write(oprot);
            }
            oprot.writeListEnd();
      ...
      if (struct.isSetFragment_ctxs()) {
        {
          ...
          for (TPlanFragmentCtx _iter52 : struct.fragment_ctxs)
          {
            _iter52.write(oprot);
          }
        }
      ...
      if (struct.isSetFragment_instance_ctxs()) {
        {
          ...
          for (TPlanFragmentInstanceCtx _iter53 : struct.fragment_instance_ctxs)
          {
            _iter53.write(oprot);
          }
        }
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.fragment_ctxs = new ArrayList<TPlanFragmentCtx>(_list54.size);
          TPlanFragmentCtx _elem55;
          for (int _i56 = 0; _i56 < _list54.size; ++_i56)
          {
            _elem55 = new TPlanFragmentCtx();
            _elem55.read(iprot);
            struct.fragment_ctxs.add(_elem55);
          }
        }
        struct.setFragment_ctxsIsSet(true);
      }
      if (incoming.get(2)) {
        {
          ...
          struct.fragment_instance_ctxs = new ArrayList<TPlanFragmentInstanceCtx>(_list57.size);
          TPlanFragmentInstanceCtx _elem58;
          for (int _i59 = 0; _i59 < _list57.size; ++_i59)
          {
            _elem58 = new TPlanFragmentInstanceCtx();
            _elem58.read(iprot);
            struct.fragment_instance_ctxs.add(_elem58);
          }
        }
        struct.setFragment_instance_ctxsIsSet(true);
      }
