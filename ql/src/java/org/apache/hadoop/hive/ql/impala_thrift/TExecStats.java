...
public class TExecStats implements org.apache.thrift.TBase<TExecStats, TExecStats._Fields>, java.io.Serializable, Cloneable, Comparable<TExecStats> {
  ...
  private long latency_ns; // optional
  private long cpu_time_ns; // optional
  private long cardinality; // optional
  private long memory_used; // optional
  ...
  public void setLatency_ns(long latency_ns) {
  ...
  public void setCpu_time_ns(long cpu_time_ns) {
