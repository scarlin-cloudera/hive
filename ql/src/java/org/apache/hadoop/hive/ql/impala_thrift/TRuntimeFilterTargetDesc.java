...
public class TRuntimeFilterTargetDesc implements org.apache.thrift.TBase<TRuntimeFilterTargetDesc, TRuntimeFilterTargetDesc._Fields>, java.io.Serializable, Cloneable, Comparable<TRuntimeFilterTargetDesc> {
  ...
  private org.apache.impala.thrift.TExpr target_expr; // required
  private boolean is_bound_by_partition_columns; // required
  private List<Integer> target_expr_slotids; // required
  private boolean is_local_target; // required
  private String kudu_col_name; // optional
  private org.apache.impala.thrift.TColumnType kudu_col_type; // optional
  ...
  public void setTarget_expr(org.apache.impala.thrift.TExpr target_expr) {
    this.target_expr = target_expr;
  }
  ...
  public void setIs_bound_by_partition_columns(boolean is_bound_by_partition_columns) {
    this.is_bound_by_partition_columns = is_bound_by_partition_columns;
    setIs_bound_by_partition_columnsIsSet(true);
  }
  ...
  public void setTarget_expr_slotids(List<Integer> target_expr_slotids) {
    this.target_expr_slotids = target_expr_slotids;
  }
  ...
  public void setIs_local_target(boolean is_local_target) {
    this.is_local_target = is_local_target;
    setIs_local_targetIsSet(true);
  }
  ...
  public void setKudu_col_name(String kudu_col_name) {
  ...
  public void setKudu_col_type(org.apache.impala.thrift.TColumnType kudu_col_type) {
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (!isSetTarget_expr()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'target_expr' is unset! Struct:" + toString());
    }

    if (!isSetIs_bound_by_partition_columns()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'is_bound_by_partition_columns' is unset! Struct:" + toString());
    }

    if (!isSetTarget_expr_slotids()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'target_expr_slotids' is unset! Struct:" + toString());
    }

    if (!isSetIs_local_target()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'is_local_target' is unset! Struct:" + toString());
    }
