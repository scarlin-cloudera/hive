...
public class TAlterDbParams implements org.apache.thrift.TBase<TAlterDbParams, TAlterDbParams._Fields>, java.io.Serializable, Cloneable, Comparable<TAlterDbParams> {
  ...
  private TAlterDbType alter_type; // required
  private String db; // required
  private TAlterDbSetOwnerParams set_owner_params; // optional
   ...
   * @see TAlterDbType
   */
  public void setAlter_type(TAlterDbType alter_type) {
    this.alter_type = alter_type;
  }
  ...
  public void setSet_owner_params(TAlterDbSetOwnerParams set_owner_params) {
