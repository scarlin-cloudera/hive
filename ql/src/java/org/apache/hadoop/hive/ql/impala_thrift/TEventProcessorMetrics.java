...
public class TEventProcessorMetrics implements org.apache.thrift.TBase<TEventProcessorMetrics, TEventProcessorMetrics._Fields>, java.io.Serializable, Cloneable, Comparable<TEventProcessorMetrics> {
  ...
  public long events_received; // optional
  public long events_skipped; // optional
  public double events_fetch_duration_mean; // optional
  public double events_process_duration_mean; // optional
  public double events_received_1min_rate; // optional
  public double events_received_5min_rate; // optional
  public double events_received_15min_rate; // optional
  public double events_skipped_per_poll_mean; // optional
  public long last_synced_event_id; // optional
  ...
  public TEventProcessorMetrics setStatus(String status) {
    this.status = status;
    return this;
  }
  ...
  public TEventProcessorMetrics setEvents_received(long events_received) {
  ...
  public TEventProcessorMetrics setEvents_skipped(long events_skipped) {
  ...
  public TEventProcessorMetrics setEvents_fetch_duration_mean(double events_fetch_duration_mean) {
  ...
  public TEventProcessorMetrics setEvents_process_duration_mean(double events_process_duration_mean) {
  ...
  public TEventProcessorMetrics setEvents_received_1min_rate(double events_received_1min_rate) {
  ...
  public TEventProcessorMetrics setEvents_received_5min_rate(double events_received_5min_rate) {
  ...
  public TEventProcessorMetrics setEvents_received_15min_rate(double events_received_15min_rate) {
  ...
  public TEventProcessorMetrics setEvents_skipped_per_poll_mean(double events_skipped_per_poll_mean) {
  ...
  public TEventProcessorMetrics setLast_synced_event_id(long last_synced_event_id) {
