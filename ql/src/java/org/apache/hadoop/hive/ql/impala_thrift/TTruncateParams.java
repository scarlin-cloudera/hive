...
public class TTruncateParams implements org.apache.thrift.TBase<TTruncateParams, TTruncateParams._Fields>, java.io.Serializable, Cloneable, Comparable<TTruncateParams> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("TTruncateParams");
  ...
  static {
    schemes.put(StandardScheme.class, new TTruncateParamsStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TTruncateParamsTupleSchemeFactory());
  }
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(TTruncateParams.class, metaDataMap);
  }

  public TTruncateParams() {
  }
   ...
   */
  public TTruncateParams(TTruncateParams other) {
  ...
  public TTruncateParams deepCopy() {
    return new TTruncateParams(this);
  }
  ...
  public TTruncateParams setTable_name(org.apache.impala.thrift.TTableName table_name) {
    this.table_name = table_name;
    return this;
  }
  ...
  public TTruncateParams setIf_exists(boolean if_exists) {
    this.if_exists = if_exists;
    setIf_existsIsSet(true);
    return this;
  }
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof TTruncateParams)
      return this.equals((TTruncateParams)that);
    return false;
  }

  public boolean equals(TTruncateParams that) {
    if (that == null)
      return false;
  ...
  @Override
  public int compareTo(TTruncateParams other) {
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TTruncateParams(");
    boolean first = true;
  ...
  private static class TTruncateParamsStandardSchemeFactory implements SchemeFactory {
    public TTruncateParamsStandardScheme getScheme() {
      return new TTruncateParamsStandardScheme();
    }
  }

  private static class TTruncateParamsStandardScheme extends StandardScheme<TTruncateParams> {

    public void read(org.apache.thrift.protocol.TProtocol iprot, TTruncateParams struct) throws org.apache.thrift.TException {
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TTruncateParams struct) throws org.apache.thrift.TException {
      struct.validate();
  ...
  private static class TTruncateParamsTupleSchemeFactory implements SchemeFactory {
    public TTruncateParamsTupleScheme getScheme() {
      return new TTruncateParamsTupleScheme();
    }
  }

  private static class TTruncateParamsTupleScheme extends TupleScheme<TTruncateParams> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, TTruncateParams struct) throws org.apache.thrift.TException {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, TTruncateParams struct) throws org.apache.thrift.TException {
