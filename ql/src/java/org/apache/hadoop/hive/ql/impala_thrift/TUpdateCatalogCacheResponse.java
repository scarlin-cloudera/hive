...
public class TUpdateCatalogCacheResponse implements org.apache.thrift.TBase<TUpdateCatalogCacheResponse, TUpdateCatalogCacheResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TUpdateCatalogCacheResponse> {
  ...
  public long min_catalog_object_version; // required
  public long new_catalog_version; // required
  ...
  public TUpdateCatalogCacheResponse setCatalog_service_id(org.apache.impala.thrift.TUniqueId catalog_service_id) {
    this.catalog_service_id = catalog_service_id;
    return this;
  }
  ...
  public TUpdateCatalogCacheResponse setMin_catalog_object_version(long min_catalog_object_version) {
    this.min_catalog_object_version = min_catalog_object_version;
    setMin_catalog_object_versionIsSet(true);
    return this;
  }
  ...
  public TUpdateCatalogCacheResponse setNew_catalog_version(long new_catalog_version) {
    this.new_catalog_version = new_catalog_version;
    setNew_catalog_versionIsSet(true);
    return this;
  }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'min_catalog_object_version' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'new_catalog_version' because it's a primitive and you chose the non-beans generator.
  ...
  private static class TUpdateCatalogCacheResponseStandardScheme extends StandardScheme<TUpdateCatalogCacheResponse> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TUpdateCatalogCacheResponse struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetMin_catalog_object_version()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'min_catalog_object_version' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetNew_catalog_version()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'new_catalog_version' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
