...
public class TPrincipal implements org.apache.thrift.TBase<TPrincipal, TPrincipal._Fields>, java.io.Serializable, Cloneable, Comparable<TPrincipal> {
  ...
  private int principal_id; // required
  private TPrincipalType principal_type; // required
  private List<String> grant_groups; // required
  ...
  public void setGrant_groups(List<String> grant_groups) {
    this.grant_groups = grant_groups;
  }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (!isSetPrincipal_id()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'principal_id' is unset! Struct:" + toString());
    }
    ...
    if (!isSetGrant_groups()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'grant_groups' is unset! Struct:" + toString());
    }
