...
public class TPartialTableInfo implements org.apache.thrift.TBase<TPartialTableInfo, TPartialTableInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TPartialTableInfo> {
  ...
  public org.apache.hadoop.hive.metastore.api.Table hms_table; // optional
  public List<TPartialPartitionInfo> partitions; // optional
  public List<org.apache.hadoop.hive.metastore.api.ColumnStatisticsObj> column_stats; // optional
  ...
  public TPartialTableInfo setHms_table(org.apache.hadoop.hive.metastore.api.Table hms_table) {
  ...
  public TPartialTableInfo setPartitions(List<TPartialPartitionInfo> partitions) {
  ...
  public TPartialTableInfo setColumn_stats(List<org.apache.hadoop.hive.metastore.api.ColumnStatisticsObj> column_stats) {
  ...
  public TPartialTableInfo setStorage_metadata_load_time_ns(long storage_metadata_load_time_ns) {
  ...
  public TPartialTableInfo setNetwork_addresses(List<org.apache.impala.thrift.TNetworkAddress> network_addresses) {
