...
public class TGetJvmThreadsInfoResponse implements org.apache.thrift.TBase<TGetJvmThreadsInfoResponse, TGetJvmThreadsInfoResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TGetJvmThreadsInfoResponse> {
  ...
  public List<TJvmThreadInfo> threads; // optional
  ...
  public TGetJvmThreadsInfoResponse setTotal_thread_count(int total_thread_count) {
    this.total_thread_count = total_thread_count;
    setTotal_thread_countIsSet(true);
    return this;
  }
  ...
  public TGetJvmThreadsInfoResponse setDaemon_thread_count(int daemon_thread_count) {
    this.daemon_thread_count = daemon_thread_count;
    setDaemon_thread_countIsSet(true);
    return this;
  }
  ...
  public TGetJvmThreadsInfoResponse setPeak_thread_count(int peak_thread_count) {
    this.peak_thread_count = peak_thread_count;
    setPeak_thread_countIsSet(true);
    return this;
  }
  ...
  public TGetJvmThreadsInfoResponse setThreads(List<TJvmThreadInfo> threads) {
  ...
  private static class TGetJvmThreadsInfoResponseStandardScheme extends StandardScheme<TGetJvmThreadsInfoResponse> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TGetJvmThreadsInfoResponse struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.threads = new ArrayList<TJvmThreadInfo>(_list200.size);
                TJvmThreadInfo _elem201;
                for (int _i202 = 0; _i202 < _list200.size; ++_i202)
                {
                  _elem201 = new TJvmThreadInfo();
                  _elem201.read(iprot);
                  struct.threads.add(_elem201);
                }
                iprot.readListEnd();
              }
      ...
      if (!struct.isSetTotal_thread_count()) {
      ...
      if (!struct.isSetDaemon_thread_count()) {
      ...
      if (!struct.isSetPeak_thread_count()) {
      ...
      if (struct.threads != null) {
        if (struct.isSetThreads()) {
          oprot.writeFieldBegin(THREADS_FIELD_DESC);
          {
            ...
            for (TJvmThreadInfo _iter203 : struct.threads)
            {
      ...
      if (struct.isSetThreads()) {
        {
          ...
          for (TJvmThreadInfo _iter204 : struct.threads)
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.threads = new ArrayList<TJvmThreadInfo>(_list205.size);
          TJvmThreadInfo _elem206;
          for (int _i207 = 0; _i207 < _list205.size; ++_i207)
          {
            _elem206 = new TJvmThreadInfo();
            _elem206.read(iprot);
            struct.threads.add(_elem206);
          }
        }
        struct.setThreadsIsSet(true);
      }
