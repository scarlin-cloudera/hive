...
public class TRuntimeProfileNode implements org.apache.thrift.TBase<TRuntimeProfileNode, TRuntimeProfileNode._Fields>, java.io.Serializable, Cloneable, Comparable<TRuntimeProfileNode> {
  ...
  private List<TCounter> counters; // required
  private long metadata; // required
  private boolean indent; // required
  private Map<String,String> info_strings; // required
  private List<String> info_strings_display_order; // required
  private Map<String,Set<String>> child_counters_map; // required
  private List<TEventSequence> event_sequences; // optional
  private List<TTimeSeriesCounter> time_series_counters; // optional
  private List<TSummaryStatsCounter> summary_stats_counters; // optional
  private TRuntimeProfileNodeMetadata node_metadata; // optional
  ...
  public TRuntimeProfileNode(TRuntimeProfileNode other) {
    ...
    if (other.isSetCounters()) {
      List<TCounter> __this__counters = new ArrayList<TCounter>(other.counters.size());
    ...
    if (other.isSetInfo_strings()) {
      Map<String,String> __this__info_strings = new HashMap<String,String>(other.info_strings);
      this.info_strings = __this__info_strings;
    }
    if (other.isSetInfo_strings_display_order()) {
      List<String> __this__info_strings_display_order = new ArrayList<String>(other.info_strings_display_order);
      this.info_strings_display_order = __this__info_strings_display_order;
    }
    if (other.isSetChild_counters_map()) {
      Map<String,Set<String>> __this__child_counters_map = new HashMap<String,Set<String>>(other.child_counters_map.size());
      for (Map.Entry<String, Set<String>> other_element : other.child_counters_map.entrySet()) {
        ...
        Set<String> __this__child_counters_map_copy_value = new HashSet<String>(other_element_value);
    ...
    if (other.isSetEvent_sequences()) {
      List<TEventSequence> __this__event_sequences = new ArrayList<TEventSequence>(other.event_sequences.size());
    ...
    if (other.isSetTime_series_counters()) {
      List<TTimeSeriesCounter> __this__time_series_counters = new ArrayList<TTimeSeriesCounter>(other.time_series_counters.size());
    ...
    if (other.isSetSummary_stats_counters()) {
      List<TSummaryStatsCounter> __this__summary_stats_counters = new ArrayList<TSummaryStatsCounter>(other.summary_stats_counters.size());
  ...
  public void setCounters(List<TCounter> counters) {
    this.counters = counters;
  }
  ...
  public void setInfo_strings(Map<String,String> info_strings) {
    this.info_strings = info_strings;
  }
  ...
  public void setInfo_strings_display_order(List<String> info_strings_display_order) {
    this.info_strings_display_order = info_strings_display_order;
  }
  ...
  public void setChild_counters_map(Map<String,Set<String>> child_counters_map) {
    this.child_counters_map = child_counters_map;
  }
  ...
  public void setEvent_sequences(List<TEventSequence> event_sequences) {
  ...
  public void setTime_series_counters(List<TTimeSeriesCounter> time_series_counters) {
  ...
  public void addToSummary_stats_counters(TSummaryStatsCounter elem) {
    if (this.summary_stats_counters == null) {
      this.summary_stats_counters = new ArrayList<TSummaryStatsCounter>();
    }
  ...
  public void setSummary_stats_counters(List<TSummaryStatsCounter> summary_stats_counters) {
  ...
  public void setNode_metadata(TRuntimeProfileNodeMetadata node_metadata) {
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case SUMMARY_STATS_COUNTERS:
      if (value == null) {
        ...
        setSummary_stats_counters((List<TSummaryStatsCounter>)value);
      }
      break;
  ...
  public int hashCode() {
    ...
    list.add(present_indent);
    if (present_indent)
      list.add(indent);

    boolean present_info_strings = true && (isSetInfo_strings());
    list.add(present_info_strings);
    if (present_info_strings)
      list.add(info_strings);

    boolean present_info_strings_display_order = true && (isSetInfo_strings_display_order());
    list.add(present_info_strings_display_order);
    if (present_info_strings_display_order)
      list.add(info_strings_display_order);

    boolean present_child_counters_map = true && (isSetChild_counters_map());
    list.add(present_child_counters_map);
    if (present_child_counters_map)
      list.add(child_counters_map);

    boolean present_event_sequences = true && (isSetEvent_sequences());
    list.add(present_event_sequences);
    if (present_event_sequences)
      list.add(event_sequences);

    boolean present_time_series_counters = true && (isSetTime_series_counters());
    list.add(present_time_series_counters);
    if (present_time_series_counters)
      list.add(time_series_counters);

    boolean present_summary_stats_counters = true && (isSetSummary_stats_counters());
    list.add(present_summary_stats_counters);
    if (present_summary_stats_counters)
      list.add(summary_stats_counters);

    boolean present_node_metadata = true && (isSetNode_metadata());
    list.add(present_node_metadata);
    if (present_node_metadata)
      list.add(node_metadata);
  ...
  public int compareTo(TRuntimeProfileNode other) {
    ...
    lastComparison = Boolean.valueOf(isSetIndent()).compareTo(other.isSetIndent());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIndent()) {
    ...
    lastComparison = Boolean.valueOf(isSetInfo_strings()).compareTo(other.isSetInfo_strings());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetInfo_strings_display_order()).compareTo(other.isSetInfo_strings_display_order());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetChild_counters_map()).compareTo(other.isSetChild_counters_map());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetEvent_sequences()).compareTo(other.isSetEvent_sequences());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetTime_series_counters()).compareTo(other.isSetTime_series_counters());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetSummary_stats_counters()).compareTo(other.isSetSummary_stats_counters());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetNode_metadata()).compareTo(other.isSetNode_metadata());
    if (lastComparison != 0) {
      return lastComparison;
    }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (!isSetCounters()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'counters' is unset! Struct:" + toString());
    }
    ...
    if (!isSetIndent()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'indent' is unset! Struct:" + toString());
    }

    if (!isSetInfo_strings()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'info_strings' is unset! Struct:" + toString());
    }

    if (!isSetInfo_strings_display_order()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'info_strings_display_order' is unset! Struct:" + toString());
    }

    if (!isSetChild_counters_map()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'child_counters_map' is unset! Struct:" + toString());
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.summary_stats_counters = new ArrayList<TSummaryStatsCounter>(_list47.size);
                TSummaryStatsCounter _elem48;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TRuntimeProfileNode struct) throws org.apache.thrift.TException {
      ...
      if (struct.info_strings != null) {
        oprot.writeFieldBegin(INFO_STRINGS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, String> _iter51 : struct.info_strings.entrySet())
          {
      ...
      if (struct.info_strings_display_order != null) {
        oprot.writeFieldBegin(INFO_STRINGS_DISPLAY_ORDER_FIELD_DESC);
        {
          ...
          for (String _iter52 : struct.info_strings_display_order)
          {
      ...
      if (struct.child_counters_map != null) {
        oprot.writeFieldBegin(CHILD_COUNTERS_MAP_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, Set<String>> _iter53 : struct.child_counters_map.entrySet())
          {
            oprot.writeString(_iter53.getKey());
            {
              ...
              for (String _iter54 : _iter53.getValue())
              {
  ...
  private static class TRuntimeProfileNodeTupleScheme extends TupleScheme<TRuntimeProfileNode> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TRuntimeProfileNode struct) throws org.apache.thrift.TException {
      ...
      oprot.writeBool(struct.indent);
      {
        ...
        for (Map.Entry<String, String> _iter59 : struct.info_strings.entrySet())
        {
      ...
      }
      {
        ...
        for (String _iter60 : struct.info_strings_display_order)
        {
      ...
      }
      {
        ...
        for (Map.Entry<String, Set<String>> _iter61 : struct.child_counters_map.entrySet())
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TRuntimeProfileNode struct) throws org.apache.thrift.TException {
      ...
      struct.setNum_childrenIsSet(true);
      {
        ...
        struct.counters = new ArrayList<TCounter>(_list66.size);
        TCounter _elem67;
      ...
      struct.setIndentIsSet(true);
      {
        ...
        struct.info_strings = new HashMap<String,String>(2*_map69.size);
        String _key70;
        String _val71;
      ...
      struct.setInfo_stringsIsSet(true);
      {
        ...
        struct.info_strings_display_order = new ArrayList<String>(_list73.size);
        String _elem74;
      ...
      struct.setInfo_strings_display_orderIsSet(true);
      {
        ...
        struct.child_counters_map = new HashMap<String,Set<String>>(2*_map76.size);
        String _key77;
        Set<String> _val78;
        for (int _i79 = 0; _i79 < _map76.size; ++_i79)
        {
          _key77 = iprot.readString();
          {
            ...
            _val78 = new HashSet<String>(2*_set80.size);
            String _elem81;
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.event_sequences = new ArrayList<TEventSequence>(_list83.size);
          TEventSequence _elem84;
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.time_series_counters = new ArrayList<TTimeSeriesCounter>(_list86.size);
          TTimeSeriesCounter _elem87;
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.summary_stats_counters = new ArrayList<TSummaryStatsCounter>(_list89.size);
          TSummaryStatsCounter _elem90;
