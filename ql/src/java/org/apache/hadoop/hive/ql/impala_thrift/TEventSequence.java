...
public class TEventSequence implements org.apache.thrift.TBase<TEventSequence, TEventSequence._Fields>, java.io.Serializable, Cloneable, Comparable<TEventSequence> {
  ...
  private List<Long> timestamps; // required
  private List<String> labels; // required
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (!isSetTimestamps()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'timestamps' is unset! Struct:" + toString());
    }

    if (!isSetLabels()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'labels' is unset! Struct:" + toString());
    }
