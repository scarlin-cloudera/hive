...
public class TScalarFunction implements org.apache.thrift.TBase<TScalarFunction, TScalarFunction._Fields>, java.io.Serializable, Cloneable, Comparable<TScalarFunction> {
  ...
  private String prepare_fn_symbol; // optional
  private String close_fn_symbol; // optional
  ...
  public void setPrepare_fn_symbol(String prepare_fn_symbol) {
  ...
  public void setClose_fn_symbol(String close_fn_symbol) {
