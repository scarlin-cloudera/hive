...
public class TPlanExecInfo implements org.apache.thrift.TBase<TPlanExecInfo, TPlanExecInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TPlanExecInfo> {
  ...
  private List<org.apache.impala.thrift.TPlanFragment> fragments; // required
  private Map<Integer,org.apache.impala.thrift.TScanRangeSpec> per_node_scan_ranges; // optional
  ...
  public void setFragments(List<org.apache.impala.thrift.TPlanFragment> fragments) {
    this.fragments = fragments;
  }
  ...
  public void setPer_node_scan_ranges(Map<Integer,org.apache.impala.thrift.TScanRangeSpec> per_node_scan_ranges) {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.fragments = new ArrayList<org.apache.impala.thrift.TPlanFragment>(_list136.size);
                org.apache.impala.thrift.TPlanFragment _elem137;
                for (int _i138 = 0; _i138 < _list136.size; ++_i138)
                {
                  _elem137 = new org.apache.impala.thrift.TPlanFragment();
                  _elem137.read(iprot);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.per_node_scan_ranges = new HashMap<Integer,org.apache.impala.thrift.TScanRangeSpec>(2*_map139.size);
                int _key140;
                org.apache.impala.thrift.TScanRangeSpec _val141;
                for (int _i142 = 0; _i142 < _map139.size; ++_i142)
                {
                  _key140 = iprot.readI32();
                  _val141 = new org.apache.impala.thrift.TScanRangeSpec();
                  _val141.read(iprot);
                  struct.per_node_scan_ranges.put(_key140, _val141);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPlanExecInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.fragments != null) {
        oprot.writeFieldBegin(FRAGMENTS_FIELD_DESC);
        {
          ...
          for (org.apache.impala.thrift.TPlanFragment _iter143 : struct.fragments)
          {
      ...
      if (struct.per_node_scan_ranges != null) {
        if (struct.isSetPer_node_scan_ranges()) {
          oprot.writeFieldBegin(PER_NODE_SCAN_RANGES_FIELD_DESC);
          {
            ...
            for (Map.Entry<Integer, org.apache.impala.thrift.TScanRangeSpec> _iter144 : struct.per_node_scan_ranges.entrySet())
            {
  ...
  private static class TPlanExecInfoTupleScheme extends TupleScheme<TPlanExecInfo> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TPlanExecInfo struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (org.apache.impala.thrift.TPlanFragment _iter145 : struct.fragments)
        {
      ...
      if (struct.isSetPer_node_scan_ranges()) {
        {
          ...
          for (Map.Entry<Integer, org.apache.impala.thrift.TScanRangeSpec> _iter146 : struct.per_node_scan_ranges.entrySet())
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TPlanExecInfo struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.fragments = new ArrayList<org.apache.impala.thrift.TPlanFragment>(_list147.size);
        org.apache.impala.thrift.TPlanFragment _elem148;
        for (int _i149 = 0; _i149 < _list147.size; ++_i149)
        {
          _elem148 = new org.apache.impala.thrift.TPlanFragment();
          _elem148.read(iprot);
      ...
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TMap _map150 = new org.apache.thrift.protocol.TMap(org.apache.thrift.protocol.TType.I32, org.apache.thrift.protocol.TType.STRUCT, iprot.readI32());
          struct.per_node_scan_ranges = new HashMap<Integer,org.apache.impala.thrift.TScanRangeSpec>(2*_map150.size);
          int _key151;
          org.apache.impala.thrift.TScanRangeSpec _val152;
          for (int _i153 = 0; _i153 < _map150.size; ++_i153)
          {
            _key151 = iprot.readI32();
            _val152 = new org.apache.impala.thrift.TScanRangeSpec();
            _val152.read(iprot);
            struct.per_node_scan_ranges.put(_key151, _val152);
          }
        }
        struct.setPer_node_scan_rangesIsSet(true);
      }
