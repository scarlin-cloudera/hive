...
public class TFunction implements org.apache.thrift.TBase<TFunction, TFunction._Fields>, java.io.Serializable, Cloneable, Comparable<TFunction> {
  ...
  private TFunctionName name; // required
  private TFunctionBinaryType binary_type; // optional
  private List<TColumnType> arg_types; // optional
  private TColumnType ret_type; // optional
  private boolean has_var_args; // optional
  private String comment; // optional
  private String signature; // optional
  private String hdfs_location; // optional
  private TScalarFunction scalar_fn; // optional
  private TAggregateFunction aggregate_fn; // optional
  private boolean is_persistent; // optional
  ...
  public void setName(TFunctionName name) {
    this.name = name;
  }
   ...
   * @see TFunctionBinaryType
   */
  public void setBinary_type(TFunctionBinaryType binary_type) {
  ...
  public void setArg_types(List<TColumnType> arg_types) {
  ...
  public void setRet_type(TColumnType ret_type) {
  ...
  public void setScalar_fn(TScalarFunction scalar_fn) {
  ...
  public void setAggregate_fn(TAggregateFunction aggregate_fn) {
  ...
  public int hashCode() {
    ...
    boolean present_has_var_args = true && (isSetHas_var_args());
