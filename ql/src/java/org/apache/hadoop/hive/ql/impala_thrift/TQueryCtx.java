...
public class TQueryCtx implements org.apache.thrift.TBase<TQueryCtx, TQueryCtx._Fields>, java.io.Serializable, Cloneable, Comparable<TQueryCtx> {
  ...
  private TClientRequest client_request; // required
  private org.apache.impala.thrift.TUniqueId query_id; // required
  private TSessionState session; // required
  private String now_string; // required
  private int pid; // required
  private org.apache.impala.thrift.TNetworkAddress coord_address; // optional
  private org.apache.impala.thrift.TNetworkAddress coord_krpc_address; // optional
  private List<org.apache.impala.thrift.TTableName> tables_missing_stats; // optional
  private boolean disable_spilling; // optional
  private org.apache.impala.thrift.TUniqueId parent_query_id; // optional
  private List<org.apache.impala.thrift.TTableName> tables_with_corrupt_stats; // optional
  private long snapshot_timestamp; // optional
  private org.apache.impala.thrift.TDescriptorTable desc_tbl_testonly; // optional
  private org.apache.impala.thrift.TDescriptorTableSerialized desc_tbl_serialized; // optional
  private long start_unix_millis; // required
  private boolean disable_codegen_hint; // optional
  private List<org.apache.impala.thrift.TTableName> tables_missing_diskids; // optional
  private String request_pool; // optional
  private String utc_timestamp_string; // required
  private String local_time_zone; // required
  private boolean disable_hbase_num_rows_estimate; // optional
  private boolean trace_resource_usage; // required
  private int status_report_interval_ms; // optional
  private int status_report_max_retry_s; // optional
  ...
  public void setClient_request(TClientRequest client_request) {
    this.client_request = client_request;
  }
  ...
  public void setSession(TSessionState session) {
    this.session = session;
  }
  ...
  public void setCoord_address(org.apache.impala.thrift.TNetworkAddress coord_address) {
  ...
  public void setCoord_krpc_address(org.apache.impala.thrift.TNetworkAddress coord_krpc_address) {
  ...
  public void setTables_missing_stats(List<org.apache.impala.thrift.TTableName> tables_missing_stats) {
  ...
  public void setDisable_spilling(boolean disable_spilling) {
  ...
  public void setParent_query_id(org.apache.impala.thrift.TUniqueId parent_query_id) {
  ...
  public void setTables_with_corrupt_stats(List<org.apache.impala.thrift.TTableName> tables_with_corrupt_stats) {
  ...
  public void setSnapshot_timestamp(long snapshot_timestamp) {
  ...
  public void setDesc_tbl_testonly(org.apache.impala.thrift.TDescriptorTable desc_tbl_testonly) {
  ...
  public void setDesc_tbl_serialized(org.apache.impala.thrift.TDescriptorTableSerialized desc_tbl_serialized) {
  ...
  public void setStart_unix_millis(long start_unix_millis) {
    this.start_unix_millis = start_unix_millis;
    setStart_unix_millisIsSet(true);
  }
  ...
  public void setDisable_codegen_hint(boolean disable_codegen_hint) {
  ...
  public void setTables_missing_diskids(List<org.apache.impala.thrift.TTableName> tables_missing_diskids) {
  ...
  public void setUtc_timestamp_string(String utc_timestamp_string) {
    this.utc_timestamp_string = utc_timestamp_string;
  }
  ...
  public void setTrace_resource_usage(boolean trace_resource_usage) {
    this.trace_resource_usage = trace_resource_usage;
    setTrace_resource_usageIsSet(true);
  }
  ...
  public void setStatus_report_interval_ms(int status_report_interval_ms) {
  ...
  public void setStatus_report_max_retry_s(int status_report_max_retry_s) {
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (!isSetClient_request()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'client_request' is unset! Struct:" + toString());
    }
    ...
    if (!isSetNow_string()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'now_string' is unset! Struct:" + toString());
    }
    ...
    if (!isSetStart_unix_millis()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'start_unix_millis' is unset! Struct:" + toString());
    }

    if (!isSetUtc_timestamp_string()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'utc_timestamp_string' is unset! Struct:" + toString());
    }

    if (!isSetLocal_time_zone()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'local_time_zone' is unset! Struct:" + toString());
    }

    if (!isSetTrace_resource_usage()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'trace_resource_usage' is unset! Struct:" + toString());
    }
