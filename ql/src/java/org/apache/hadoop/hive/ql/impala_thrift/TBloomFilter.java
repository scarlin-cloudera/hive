...
public class TBloomFilter implements org.apache.thrift.TBase<TBloomFilter, TBloomFilter._Fields>, java.io.Serializable, Cloneable, Comparable<TBloomFilter> {
  ...
  public int log_bufferpool_space; // required
  public ByteBuffer directory; // required
  ...
  public TBloomFilter setLog_bufferpool_space(int log_bufferpool_space) {
    this.log_bufferpool_space = log_bufferpool_space;
    setLog_bufferpool_spaceIsSet(true);
    return this;
  }
  ...
  public TBloomFilter setAlways_true(boolean always_true) {
    this.always_true = always_true;
    setAlways_trueIsSet(true);
    return this;
  }
  ...
  public TBloomFilter setAlways_false(boolean always_false) {
    this.always_false = always_false;
    setAlways_falseIsSet(true);
    return this;
  }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'log_bufferpool_space' because it's a primitive and you chose the non-beans generator.
  ...
  private static class TBloomFilterStandardScheme extends StandardScheme<TBloomFilter> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TBloomFilter struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetLog_bufferpool_space()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'log_bufferpool_space' was not found in serialized data! Struct: " + toString());
      }
