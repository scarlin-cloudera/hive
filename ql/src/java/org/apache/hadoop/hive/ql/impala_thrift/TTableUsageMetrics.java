...
public class TTableUsageMetrics implements org.apache.thrift.TBase<TTableUsageMetrics, TTableUsageMetrics._Fields>, java.io.Serializable, Cloneable, Comparable<TTableUsageMetrics> {
  ...
  public long memory_estimate_bytes; // optional
  public long num_metadata_operations; // optional
  public long num_files; // optional
  ...
  public TTableUsageMetrics setTable_name(org.apache.impala.thrift.TTableName table_name) {
    this.table_name = table_name;
    return this;
  }
  ...
  public TTableUsageMetrics setMemory_estimate_bytes(long memory_estimate_bytes) {
  ...
  public TTableUsageMetrics setNum_metadata_operations(long num_metadata_operations) {
  ...
  public TTableUsageMetrics setNum_files(long num_files) {
