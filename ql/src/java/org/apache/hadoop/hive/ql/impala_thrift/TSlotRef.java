...
public class TSlotRef implements org.apache.thrift.TBase<TSlotRef, TSlotRef._Fields>, java.io.Serializable, Cloneable, Comparable<TSlotRef> {
  ...
  static {
    schemes.put(StandardScheme.class, new TSlotRefStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TSlotRefTupleSchemeFactory());
  }

  private int slot_id; // required
  ...
  public void unsetSlot_id() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __SLOT_ID_ISSET_ID);
  }

  /** Returns true if field slot_id is set (has been assigned a value) and false otherwise */
  public boolean isSetSlot_id() {
    return EncodingUtils.testBit(__isset_bitfield, __SLOT_ID_ISSET_ID);
  }

  public void setSlot_idIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __SLOT_ID_ISSET_ID, value);
  }
  ...
  public int hashCode() {
    ...
    boolean present_slot_id = true;
    list.add(present_slot_id);
    if (present_slot_id)
      list.add(slot_id);
  ...
  public int compareTo(TSlotRef other) {
    ...
    lastComparison = Boolean.valueOf(isSetSlot_id()).compareTo(other.isSetSlot_id());
    if (lastComparison != 0) {
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (!isSetSlot_id()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'slot_id' is unset! Struct:" + toString());
    }
  ...
  private static class TSlotRefStandardScheme extends StandardScheme<TSlotRef> {
  ...
  private static class TSlotRefTupleScheme extends TupleScheme<TSlotRef> {
