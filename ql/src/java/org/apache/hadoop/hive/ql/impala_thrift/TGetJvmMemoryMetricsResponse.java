...
public class TGetJvmMemoryMetricsResponse implements org.apache.thrift.TBase<TGetJvmMemoryMetricsResponse, TGetJvmMemoryMetricsResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TGetJvmMemoryMetricsResponse> {
  ...
  private List<TJvmMemoryPool> memory_pools; // required
  private long gc_num_warn_threshold_exceeded; // required
  private long gc_num_info_threshold_exceeded; // required
  private long gc_total_extra_sleep_time_millis; // required
  private long gc_count; // required
  private long gc_time_millis; // required
  ...
  public void setMemory_pools(List<TJvmMemoryPool> memory_pools) {
    this.memory_pools = memory_pools;
  }
  ...
  public void setGc_num_warn_threshold_exceeded(long gc_num_warn_threshold_exceeded) {
    this.gc_num_warn_threshold_exceeded = gc_num_warn_threshold_exceeded;
    setGc_num_warn_threshold_exceededIsSet(true);
  }
  ...
  public void setGc_num_info_threshold_exceeded(long gc_num_info_threshold_exceeded) {
    this.gc_num_info_threshold_exceeded = gc_num_info_threshold_exceeded;
    setGc_num_info_threshold_exceededIsSet(true);
  }
  ...
  public void setGc_total_extra_sleep_time_millis(long gc_total_extra_sleep_time_millis) {
    this.gc_total_extra_sleep_time_millis = gc_total_extra_sleep_time_millis;
    setGc_total_extra_sleep_time_millisIsSet(true);
  }
  ...
  public void setGc_count(long gc_count) {
    this.gc_count = gc_count;
    setGc_countIsSet(true);
  }
  ...
  public void setGc_time_millis(long gc_time_millis) {
    this.gc_time_millis = gc_time_millis;
    setGc_time_millisIsSet(true);
  }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (!isSetMemory_pools()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'memory_pools' is unset! Struct:" + toString());
    }

    if (!isSetGc_num_warn_threshold_exceeded()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'gc_num_warn_threshold_exceeded' is unset! Struct:" + toString());
    }

    if (!isSetGc_num_info_threshold_exceeded()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'gc_num_info_threshold_exceeded' is unset! Struct:" + toString());
    }

    if (!isSetGc_total_extra_sleep_time_millis()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'gc_total_extra_sleep_time_millis' is unset! Struct:" + toString());
    }

    if (!isSetGc_count()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'gc_count' is unset! Struct:" + toString());
    }

    if (!isSetGc_time_millis()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'gc_time_millis' is unset! Struct:" + toString());
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.memory_pools = new ArrayList<TJvmMemoryPool>(_list226.size);
                TJvmMemoryPool _elem227;
                for (int _i228 = 0; _i228 < _list226.size; ++_i228)
                {
                  _elem227 = new TJvmMemoryPool();
                  _elem227.read(iprot);
                  struct.memory_pools.add(_elem227);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TGetJvmMemoryMetricsResponse struct) throws org.apache.thrift.TException {
      ...
      if (struct.memory_pools != null) {
        oprot.writeFieldBegin(MEMORY_POOLS_FIELD_DESC);
        {
          ...
          for (TJvmMemoryPool _iter229 : struct.memory_pools)
          {
  ...
  private static class TGetJvmMemoryMetricsResponseTupleScheme extends TupleScheme<TGetJvmMemoryMetricsResponse> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TGetJvmMemoryMetricsResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (TJvmMemoryPool _iter230 : struct.memory_pools)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TGetJvmMemoryMetricsResponse struct) throws org.apache.thrift.TException {
      TTupleProtocol iprot = (TTupleProtocol) prot;
      {
        ...
        struct.memory_pools = new ArrayList<TJvmMemoryPool>(_list231.size);
        TJvmMemoryPool _elem232;
        for (int _i233 = 0; _i233 < _list231.size; ++_i233)
        {
          _elem232 = new TJvmMemoryPool();
          _elem232.read(iprot);
          struct.memory_pools.add(_elem232);
        }
      }
      struct.setMemory_poolsIsSet(true);
      struct.gc_num_warn_threshold_exceeded = iprot.readI64();
