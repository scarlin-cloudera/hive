...
public class TPoolConfig implements org.apache.thrift.TBase<TPoolConfig, TPoolConfig._Fields>, java.io.Serializable, Cloneable, Comparable<TPoolConfig> {
  ...
  public long max_mem_resources; // required
  public long queue_timeout_ms; // optional
  public String default_query_options; // required
  public long max_query_mem_limit; // required
  public long min_query_mem_limit; // required
  public boolean clamp_mem_limit_query_option; // required
  public double max_running_queries_multiple; // required
  public double max_queued_queries_multiple; // required
  public long max_memory_multiple; // required
  ...
  public TPoolConfig setMax_requests(long max_requests) {
    this.max_requests = max_requests;
    setMax_requestsIsSet(true);
    return this;
  }
  ...
  public TPoolConfig setMax_queued(long max_queued) {
    this.max_queued = max_queued;
    setMax_queuedIsSet(true);
    return this;
  }
  ...
  public TPoolConfig setMax_mem_resources(long max_mem_resources) {
    this.max_mem_resources = max_mem_resources;
    setMax_mem_resourcesIsSet(true);
    return this;
  }
  ...
  public TPoolConfig setQueue_timeout_ms(long queue_timeout_ms) {
  ...
  public TPoolConfig setDefault_query_options(String default_query_options) {
    this.default_query_options = default_query_options;
    return this;
  }
  ...
  public TPoolConfig setMax_query_mem_limit(long max_query_mem_limit) {
    this.max_query_mem_limit = max_query_mem_limit;
    setMax_query_mem_limitIsSet(true);
    return this;
  }
  ...
  public TPoolConfig setMin_query_mem_limit(long min_query_mem_limit) {
    this.min_query_mem_limit = min_query_mem_limit;
    setMin_query_mem_limitIsSet(true);
    return this;
  }
  ...
  public TPoolConfig setClamp_mem_limit_query_option(boolean clamp_mem_limit_query_option) {
    this.clamp_mem_limit_query_option = clamp_mem_limit_query_option;
    setClamp_mem_limit_query_optionIsSet(true);
    return this;
  }
  ...
  public TPoolConfig setMax_running_queries_multiple(double max_running_queries_multiple) {
    this.max_running_queries_multiple = max_running_queries_multiple;
    setMax_running_queries_multipleIsSet(true);
    return this;
  }
  ...
  public TPoolConfig setMax_queued_queries_multiple(double max_queued_queries_multiple) {
    this.max_queued_queries_multiple = max_queued_queries_multiple;
    setMax_queued_queries_multipleIsSet(true);
    return this;
  }
  ...
  public TPoolConfig setMax_memory_multiple(long max_memory_multiple) {
    this.max_memory_multiple = max_memory_multiple;
    setMax_memory_multipleIsSet(true);
    return this;
  }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'max_mem_resources' because it's a primitive and you chose the non-beans generator.
    if (default_query_options == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'default_query_options' was not present! Struct: " + toString());
    }
    // alas, we cannot check 'max_query_mem_limit' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'min_query_mem_limit' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'clamp_mem_limit_query_option' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'max_running_queries_multiple' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'max_queued_queries_multiple' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'max_memory_multiple' because it's a primitive and you chose the non-beans generator.
  ...
  private static class TPoolConfigStandardScheme extends StandardScheme<TPoolConfig> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TPoolConfig struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetMax_mem_resources()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'max_mem_resources' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetMax_query_mem_limit()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'max_query_mem_limit' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetMin_query_mem_limit()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'min_query_mem_limit' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetClamp_mem_limit_query_option()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'clamp_mem_limit_query_option' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetMax_running_queries_multiple()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'max_running_queries_multiple' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetMax_queued_queries_multiple()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'max_queued_queries_multiple' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetMax_memory_multiple()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'max_memory_multiple' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
