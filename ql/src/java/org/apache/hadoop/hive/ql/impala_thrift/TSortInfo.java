...
public class TSortInfo implements org.apache.thrift.TBase<TSortInfo, TSortInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TSortInfo> {
  ...
  private List<org.apache.impala.thrift.TExpr> ordering_exprs; // required
  private List<Boolean> is_asc_order; // required
  private List<Boolean> nulls_first; // required
  private List<org.apache.impala.thrift.TExpr> sort_tuple_slot_exprs; // optional
  ...
  public void setOrdering_exprs(List<org.apache.impala.thrift.TExpr> ordering_exprs) {
    this.ordering_exprs = ordering_exprs;
  }
  ...
  public void setIs_asc_order(List<Boolean> is_asc_order) {
    this.is_asc_order = is_asc_order;
  }
  ...
  public void setNulls_first(List<Boolean> nulls_first) {
    this.nulls_first = nulls_first;
  }
  ...
  public void setSort_tuple_slot_exprs(List<org.apache.impala.thrift.TExpr> sort_tuple_slot_exprs) {
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (!isSetOrdering_exprs()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'ordering_exprs' is unset! Struct:" + toString());
    }

    if (!isSetIs_asc_order()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'is_asc_order' is unset! Struct:" + toString());
    }

    if (!isSetNulls_first()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'nulls_first' is unset! Struct:" + toString());
    }
