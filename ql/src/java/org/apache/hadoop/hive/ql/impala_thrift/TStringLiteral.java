...
public class TStringLiteral implements org.apache.thrift.TBase<TStringLiteral, TStringLiteral._Fields>, java.io.Serializable, Cloneable, Comparable<TStringLiteral> {
  ...
  static {
    schemes.put(StandardScheme.class, new TStringLiteralStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TStringLiteralTupleSchemeFactory());
  }
  ...
  public TStringLiteral setValue(String value) {
    this.value = value;
    return this;
  }
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("TStringLiteral(");
    boolean first = true;
  ...
  private static class TStringLiteralStandardSchemeFactory implements SchemeFactory {
    public TStringLiteralStandardScheme getScheme() {
      return new TStringLiteralStandardScheme();
    }
  }

  private static class TStringLiteralStandardScheme extends StandardScheme<TStringLiteral> {
  ...
  private static class TStringLiteralTupleSchemeFactory implements SchemeFactory {
    public TStringLiteralTupleScheme getScheme() {
      return new TStringLiteralTupleScheme();
    }
  }

  private static class TStringLiteralTupleScheme extends TupleScheme<TStringLiteral> {
