...
public class TUniqueId implements org.apache.thrift.TBase<TUniqueId, TUniqueId._Fields>, java.io.Serializable, Cloneable, Comparable<TUniqueId> {
  ...
  private long hi; // required
  private long lo; // required
  ...
  public int hashCode() {
    ...
    boolean present_hi = true;
    list.add(present_hi);
    if (present_hi)
      list.add(hi);

    boolean present_lo = true;
    list.add(present_lo);
    if (present_lo)
      list.add(lo);
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (!isSetHi()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'hi' is unset! Struct:" + toString());
    }

    if (!isSetLo()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'lo' is unset! Struct:" + toString());
    }
