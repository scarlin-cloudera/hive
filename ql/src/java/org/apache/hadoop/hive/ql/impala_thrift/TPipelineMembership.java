...
public class TPipelineMembership implements org.apache.thrift.TBase<TPipelineMembership, TPipelineMembership._Fields>, java.io.Serializable, Cloneable, Comparable<TPipelineMembership> {
  ...
  public int pipe_id; // required
  public int height; // required
  /**
   * 
   * @see TExecNodePhase
   */
  public TExecNodePhase phase; // required
  ...
  public TPipelineMembership setPipe_id(int pipe_id) {
    this.pipe_id = pipe_id;
    setPipe_idIsSet(true);
    return this;
  }
  ...
  public TPipelineMembership setHeight(int height) {
    this.height = height;
    setHeightIsSet(true);
    return this;
  }
   ...
   * @see TExecNodePhase
   */
  public TPipelineMembership setPhase(TExecNodePhase phase) {
    this.phase = phase;
    return this;
  }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'pipe_id' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'height' because it's a primitive and you chose the non-beans generator.
    if (phase == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'phase' was not present! Struct: " + toString());
    }
  ...
  private static class TPipelineMembershipStandardScheme extends StandardScheme<TPipelineMembership> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TPipelineMembership struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetPipe_id()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'pipe_id' was not found in serialized data! Struct: " + toString());
      }
