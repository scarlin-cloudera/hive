...
public class TBackendGflags implements org.apache.thrift.TBase<TBackendGflags, TBackendGflags._Fields>, java.io.Serializable, Cloneable, Comparable<TBackendGflags> {
  ...
  private static final org.apache.thrift.protocol.TField SIMPLIFY_CHECK_ON_SHOW_TABLES_FIELD_DESC = new org.apache.thrift.protocol.TField("simplify_check_on_show_tables", org.apache.thrift.protocol.TType.BOOL, (short)60);
  private static final org.apache.thrift.protocol.TField MT_DOP_AUTO_FALLBACK_FIELD_DESC = new org.apache.thrift.protocol.TField("mt_dop_auto_fallback", org.apache.thrift.protocol.TType.BOOL, (short)61);
  ...
  public String sentry_config; // required
  public boolean load_auth_to_local_rules; // required
  public int non_impala_java_vlog; // required
  public int impala_log_lvl; // required
  public long inc_stats_size_limit_bytes; // required
  public String lineage_event_log_dir; // required
  public boolean load_catalog_in_background; // required
  public int num_metadata_loading_threads; // required
  public String principal; // required
  public String server_name; // required
  public String authorization_policy_provider_class; // required
  public String kudu_master_hosts; // required
  public String local_library_path; // required
  public int read_size; // required
  public int kudu_operation_timeout_ms; // required
  public int initial_hms_cnxn_timeout_s; // required
  public boolean enable_stats_extrapolation; // required
  public long sentry_catalog_polling_frequency_s; // required
  public int max_hdfs_partitions_parallel_load; // required
  public int max_nonhdfs_partitions_parallel_load; // required
  /**
   * 
   * @see TReservedWordsVersion
   */
  public TReservedWordsVersion reserved_words_version; // required
  public double max_filter_error_rate; // required
  public long min_buffer_size; // required
  public boolean enable_orc_scanner; // required
  public String authorized_proxy_group_config; // required
  public boolean use_local_catalog; // required
  public boolean disable_catalog_data_ops_debug_only; // required
  public int local_catalog_cache_mb; // required
  public int local_catalog_cache_expiration_s; // required
  public String catalog_topic_mode; // required
  public int invalidate_tables_timeout_s; // required
  public boolean invalidate_tables_on_memory_pressure; // required
  public double invalidate_tables_gc_old_gen_full_threshold; // required
  public double invalidate_tables_fraction_on_memory_pressure; // required
  public int local_catalog_max_fetch_retries; // required
  public long kudu_scanner_thread_estimated_bytes_per_column; // required
  public long kudu_scanner_thread_max_estimated_bytes; // required
  public int catalog_max_parallel_partial_fetch_rpc; // required
  public long catalog_partial_fetch_rpc_queue_timeout_s; // required
  public long exchg_node_buffer_size_bytes; // required
  public int kudu_mutation_buffer_size; // required
  public int kudu_error_buffer_size; // required
  public int hms_event_polling_interval_s; // required
  public String impala_build_version; // required
  public String authorization_factory_class; // required
  public boolean unlock_mt_dop; // required
  public String ranger_service_type; // required
  public String ranger_app_id; // required
  public String authorization_provider; // required
  public boolean recursively_list_partitions; // required
  public String query_event_hook_classes; // required
  public int query_event_hook_nthreads; // required
  public boolean is_executor; // required
  public boolean use_dedicated_coordinator_estimates; // required
  public String blacklisted_dbs; // required
  public String blacklisted_tables; // required
  public boolean unlock_zorder_sort; // required
  public boolean simplify_check_on_show_tables; // required
  public boolean mt_dop_auto_fallback; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    SIMPLIFY_CHECK_ON_SHOW_TABLES((short)60, "simplify_check_on_show_tables"),
    MT_DOP_AUTO_FALLBACK((short)61, "mt_dop_auto_fallback");
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 60: // SIMPLIFY_CHECK_ON_SHOW_TABLES
          return SIMPLIFY_CHECK_ON_SHOW_TABLES;
        case 61: // MT_DOP_AUTO_FALLBACK
          return MT_DOP_AUTO_FALLBACK;
        default:
          return null;
      }
    }
  ...
  private static final int __SIMPLIFY_CHECK_ON_SHOW_TABLES_ISSET_ID = 39;
  private static final int __MT_DOP_AUTO_FALLBACK_ISSET_ID = 40;
  ...
  static {
    ...
    tmpMap.put(_Fields.UNLOCK_ZORDER_SORT, new org.apache.thrift.meta_data.FieldMetaData("unlock_zorder_sort", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
    tmpMap.put(_Fields.SIMPLIFY_CHECK_ON_SHOW_TABLES, new org.apache.thrift.meta_data.FieldMetaData("simplify_check_on_show_tables", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
    tmpMap.put(_Fields.MT_DOP_AUTO_FALLBACK, new org.apache.thrift.meta_data.FieldMetaData("mt_dop_auto_fallback", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.BOOL)));
  ...
  public TBackendGflags(
    ...
    boolean simplify_check_on_show_tables,
    boolean mt_dop_auto_fallback)
  {
    this();
    ...
    this.simplify_check_on_show_tables = simplify_check_on_show_tables;
    setSimplify_check_on_show_tablesIsSet(true);
    this.mt_dop_auto_fallback = mt_dop_auto_fallback;
    setMt_dop_auto_fallbackIsSet(true);
  }
  ...
  public TBackendGflags(TBackendGflags other) {
    ...
    this.simplify_check_on_show_tables = other.simplify_check_on_show_tables;
    this.mt_dop_auto_fallback = other.mt_dop_auto_fallback;
  }
  ...
  public void clear() {
    ...
    setSimplify_check_on_show_tablesIsSet(false);
    this.simplify_check_on_show_tables = false;
    setMt_dop_auto_fallbackIsSet(false);
    this.mt_dop_auto_fallback = false;
  }
  ...
  public TBackendGflags setSentry_config(String sentry_config) {
    this.sentry_config = sentry_config;
    return this;
  }
  ...
  public TBackendGflags setLoad_auth_to_local_rules(boolean load_auth_to_local_rules) {
    this.load_auth_to_local_rules = load_auth_to_local_rules;
    setLoad_auth_to_local_rulesIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setNon_impala_java_vlog(int non_impala_java_vlog) {
    this.non_impala_java_vlog = non_impala_java_vlog;
    setNon_impala_java_vlogIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setImpala_log_lvl(int impala_log_lvl) {
    this.impala_log_lvl = impala_log_lvl;
    setImpala_log_lvlIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setInc_stats_size_limit_bytes(long inc_stats_size_limit_bytes) {
    this.inc_stats_size_limit_bytes = inc_stats_size_limit_bytes;
    setInc_stats_size_limit_bytesIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setLineage_event_log_dir(String lineage_event_log_dir) {
    this.lineage_event_log_dir = lineage_event_log_dir;
    return this;
  }
  ...
  public TBackendGflags setLoad_catalog_in_background(boolean load_catalog_in_background) {
    this.load_catalog_in_background = load_catalog_in_background;
    setLoad_catalog_in_backgroundIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setNum_metadata_loading_threads(int num_metadata_loading_threads) {
    this.num_metadata_loading_threads = num_metadata_loading_threads;
    setNum_metadata_loading_threadsIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setPrincipal(String principal) {
    this.principal = principal;
    return this;
  }
  ...
  public TBackendGflags setServer_name(String server_name) {
    this.server_name = server_name;
    return this;
  }
  ...
  public TBackendGflags setAuthorization_policy_provider_class(String authorization_policy_provider_class) {
    this.authorization_policy_provider_class = authorization_policy_provider_class;
    return this;
  }
  ...
  public TBackendGflags setKudu_master_hosts(String kudu_master_hosts) {
    this.kudu_master_hosts = kudu_master_hosts;
    return this;
  }
  ...
  public TBackendGflags setLocal_library_path(String local_library_path) {
    this.local_library_path = local_library_path;
    return this;
  }
  ...
  public TBackendGflags setRead_size(int read_size) {
    this.read_size = read_size;
    setRead_sizeIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setKudu_operation_timeout_ms(int kudu_operation_timeout_ms) {
    this.kudu_operation_timeout_ms = kudu_operation_timeout_ms;
    setKudu_operation_timeout_msIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setInitial_hms_cnxn_timeout_s(int initial_hms_cnxn_timeout_s) {
    this.initial_hms_cnxn_timeout_s = initial_hms_cnxn_timeout_s;
    setInitial_hms_cnxn_timeout_sIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setEnable_stats_extrapolation(boolean enable_stats_extrapolation) {
    this.enable_stats_extrapolation = enable_stats_extrapolation;
    setEnable_stats_extrapolationIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setSentry_catalog_polling_frequency_s(long sentry_catalog_polling_frequency_s) {
    this.sentry_catalog_polling_frequency_s = sentry_catalog_polling_frequency_s;
    setSentry_catalog_polling_frequency_sIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setMax_hdfs_partitions_parallel_load(int max_hdfs_partitions_parallel_load) {
    this.max_hdfs_partitions_parallel_load = max_hdfs_partitions_parallel_load;
    setMax_hdfs_partitions_parallel_loadIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setMax_nonhdfs_partitions_parallel_load(int max_nonhdfs_partitions_parallel_load) {
    this.max_nonhdfs_partitions_parallel_load = max_nonhdfs_partitions_parallel_load;
    setMax_nonhdfs_partitions_parallel_loadIsSet(true);
    return this;
  }
   ...
   * @see TReservedWordsVersion
   */
  public TBackendGflags setReserved_words_version(TReservedWordsVersion reserved_words_version) {
    this.reserved_words_version = reserved_words_version;
    return this;
  }
  ...
  public TBackendGflags setMax_filter_error_rate(double max_filter_error_rate) {
    this.max_filter_error_rate = max_filter_error_rate;
    setMax_filter_error_rateIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setMin_buffer_size(long min_buffer_size) {
    this.min_buffer_size = min_buffer_size;
    setMin_buffer_sizeIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setEnable_orc_scanner(boolean enable_orc_scanner) {
    this.enable_orc_scanner = enable_orc_scanner;
    setEnable_orc_scannerIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setAuthorized_proxy_group_config(String authorized_proxy_group_config) {
    this.authorized_proxy_group_config = authorized_proxy_group_config;
    return this;
  }
  ...
  public TBackendGflags setUse_local_catalog(boolean use_local_catalog) {
    this.use_local_catalog = use_local_catalog;
    setUse_local_catalogIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setDisable_catalog_data_ops_debug_only(boolean disable_catalog_data_ops_debug_only) {
    this.disable_catalog_data_ops_debug_only = disable_catalog_data_ops_debug_only;
    setDisable_catalog_data_ops_debug_onlyIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setLocal_catalog_cache_mb(int local_catalog_cache_mb) {
    this.local_catalog_cache_mb = local_catalog_cache_mb;
    setLocal_catalog_cache_mbIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setLocal_catalog_cache_expiration_s(int local_catalog_cache_expiration_s) {
    this.local_catalog_cache_expiration_s = local_catalog_cache_expiration_s;
    setLocal_catalog_cache_expiration_sIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setCatalog_topic_mode(String catalog_topic_mode) {
    this.catalog_topic_mode = catalog_topic_mode;
    return this;
  }
  ...
  public TBackendGflags setInvalidate_tables_timeout_s(int invalidate_tables_timeout_s) {
    this.invalidate_tables_timeout_s = invalidate_tables_timeout_s;
    setInvalidate_tables_timeout_sIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setInvalidate_tables_on_memory_pressure(boolean invalidate_tables_on_memory_pressure) {
    this.invalidate_tables_on_memory_pressure = invalidate_tables_on_memory_pressure;
    setInvalidate_tables_on_memory_pressureIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setInvalidate_tables_gc_old_gen_full_threshold(double invalidate_tables_gc_old_gen_full_threshold) {
    this.invalidate_tables_gc_old_gen_full_threshold = invalidate_tables_gc_old_gen_full_threshold;
    setInvalidate_tables_gc_old_gen_full_thresholdIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setInvalidate_tables_fraction_on_memory_pressure(double invalidate_tables_fraction_on_memory_pressure) {
    this.invalidate_tables_fraction_on_memory_pressure = invalidate_tables_fraction_on_memory_pressure;
    setInvalidate_tables_fraction_on_memory_pressureIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setLocal_catalog_max_fetch_retries(int local_catalog_max_fetch_retries) {
    this.local_catalog_max_fetch_retries = local_catalog_max_fetch_retries;
    setLocal_catalog_max_fetch_retriesIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setKudu_scanner_thread_estimated_bytes_per_column(long kudu_scanner_thread_estimated_bytes_per_column) {
    this.kudu_scanner_thread_estimated_bytes_per_column = kudu_scanner_thread_estimated_bytes_per_column;
    setKudu_scanner_thread_estimated_bytes_per_columnIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setKudu_scanner_thread_max_estimated_bytes(long kudu_scanner_thread_max_estimated_bytes) {
    this.kudu_scanner_thread_max_estimated_bytes = kudu_scanner_thread_max_estimated_bytes;
    setKudu_scanner_thread_max_estimated_bytesIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setCatalog_max_parallel_partial_fetch_rpc(int catalog_max_parallel_partial_fetch_rpc) {
    this.catalog_max_parallel_partial_fetch_rpc = catalog_max_parallel_partial_fetch_rpc;
    setCatalog_max_parallel_partial_fetch_rpcIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setCatalog_partial_fetch_rpc_queue_timeout_s(long catalog_partial_fetch_rpc_queue_timeout_s) {
    this.catalog_partial_fetch_rpc_queue_timeout_s = catalog_partial_fetch_rpc_queue_timeout_s;
    setCatalog_partial_fetch_rpc_queue_timeout_sIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setExchg_node_buffer_size_bytes(long exchg_node_buffer_size_bytes) {
    this.exchg_node_buffer_size_bytes = exchg_node_buffer_size_bytes;
    setExchg_node_buffer_size_bytesIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setKudu_mutation_buffer_size(int kudu_mutation_buffer_size) {
    this.kudu_mutation_buffer_size = kudu_mutation_buffer_size;
    setKudu_mutation_buffer_sizeIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setKudu_error_buffer_size(int kudu_error_buffer_size) {
    this.kudu_error_buffer_size = kudu_error_buffer_size;
    setKudu_error_buffer_sizeIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setHms_event_polling_interval_s(int hms_event_polling_interval_s) {
    this.hms_event_polling_interval_s = hms_event_polling_interval_s;
    setHms_event_polling_interval_sIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setImpala_build_version(String impala_build_version) {
    this.impala_build_version = impala_build_version;
    return this;
  }
  ...
  public TBackendGflags setAuthorization_factory_class(String authorization_factory_class) {
    this.authorization_factory_class = authorization_factory_class;
    return this;
  }
  ...
  public TBackendGflags setUnlock_mt_dop(boolean unlock_mt_dop) {
    this.unlock_mt_dop = unlock_mt_dop;
    setUnlock_mt_dopIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setRanger_service_type(String ranger_service_type) {
    this.ranger_service_type = ranger_service_type;
    return this;
  }
  ...
  public TBackendGflags setRanger_app_id(String ranger_app_id) {
    this.ranger_app_id = ranger_app_id;
    return this;
  }
  ...
  public TBackendGflags setAuthorization_provider(String authorization_provider) {
    this.authorization_provider = authorization_provider;
    return this;
  }
  ...
  public TBackendGflags setRecursively_list_partitions(boolean recursively_list_partitions) {
    this.recursively_list_partitions = recursively_list_partitions;
    setRecursively_list_partitionsIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setQuery_event_hook_classes(String query_event_hook_classes) {
    this.query_event_hook_classes = query_event_hook_classes;
    return this;
  }
  ...
  public TBackendGflags setQuery_event_hook_nthreads(int query_event_hook_nthreads) {
    this.query_event_hook_nthreads = query_event_hook_nthreads;
    setQuery_event_hook_nthreadsIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setIs_executor(boolean is_executor) {
    this.is_executor = is_executor;
    setIs_executorIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setUse_dedicated_coordinator_estimates(boolean use_dedicated_coordinator_estimates) {
    this.use_dedicated_coordinator_estimates = use_dedicated_coordinator_estimates;
    setUse_dedicated_coordinator_estimatesIsSet(true);
    return this;
  }
  ...
  public TBackendGflags setBlacklisted_dbs(String blacklisted_dbs) {
    this.blacklisted_dbs = blacklisted_dbs;
    return this;
  }
  ...
  public TBackendGflags setBlacklisted_tables(String blacklisted_tables) {
    this.blacklisted_tables = blacklisted_tables;
    return this;
  }
  ...
  public TBackendGflags setUnlock_zorder_sort(boolean unlock_zorder_sort) {
    this.unlock_zorder_sort = unlock_zorder_sort;
    setUnlock_zorder_sortIsSet(true);
    return this;
  }
  ...
  public boolean isSimplify_check_on_show_tables() {
    return this.simplify_check_on_show_tables;
  }

  public TBackendGflags setSimplify_check_on_show_tables(boolean simplify_check_on_show_tables) {
    this.simplify_check_on_show_tables = simplify_check_on_show_tables;
    setSimplify_check_on_show_tablesIsSet(true);
    return this;
  }

  public void unsetSimplify_check_on_show_tables() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __SIMPLIFY_CHECK_ON_SHOW_TABLES_ISSET_ID);
  }

  /** Returns true if field simplify_check_on_show_tables is set (has been assigned a value) and false otherwise */
  public boolean isSetSimplify_check_on_show_tables() {
    return EncodingUtils.testBit(__isset_bitfield, __SIMPLIFY_CHECK_ON_SHOW_TABLES_ISSET_ID);
  }

  public void setSimplify_check_on_show_tablesIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __SIMPLIFY_CHECK_ON_SHOW_TABLES_ISSET_ID, value);
  }

  public boolean isMt_dop_auto_fallback() {
    return this.mt_dop_auto_fallback;
  }

  public TBackendGflags setMt_dop_auto_fallback(boolean mt_dop_auto_fallback) {
    this.mt_dop_auto_fallback = mt_dop_auto_fallback;
    setMt_dop_auto_fallbackIsSet(true);
    return this;
  }

  public void unsetMt_dop_auto_fallback() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __MT_DOP_AUTO_FALLBACK_ISSET_ID);
  }

  /** Returns true if field mt_dop_auto_fallback is set (has been assigned a value) and false otherwise */
  public boolean isSetMt_dop_auto_fallback() {
    return EncodingUtils.testBit(__isset_bitfield, __MT_DOP_AUTO_FALLBACK_ISSET_ID);
  }

  public void setMt_dop_auto_fallbackIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __MT_DOP_AUTO_FALLBACK_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case SIMPLIFY_CHECK_ON_SHOW_TABLES:
      if (value == null) {
        unsetSimplify_check_on_show_tables();
      } else {
        setSimplify_check_on_show_tables((Boolean)value);
      }
      break;

    case MT_DOP_AUTO_FALLBACK:
      if (value == null) {
        unsetMt_dop_auto_fallback();
      } else {
        setMt_dop_auto_fallback((Boolean)value);
      }
      break;
  ...
  public Object getFieldValue(_Fields field) {
    ...
    case SIMPLIFY_CHECK_ON_SHOW_TABLES:
      return isSimplify_check_on_show_tables();

    case MT_DOP_AUTO_FALLBACK:
      return isMt_dop_auto_fallback();
  ...
  public boolean isSet(_Fields field) {
    ...
    case SIMPLIFY_CHECK_ON_SHOW_TABLES:
      return isSetSimplify_check_on_show_tables();
    case MT_DOP_AUTO_FALLBACK:
      return isSetMt_dop_auto_fallback();
    }
    throw new IllegalStateException();
  }
  ...
  public boolean equals(TBackendGflags that) {
    ...
    boolean this_present_simplify_check_on_show_tables = true;
    boolean that_present_simplify_check_on_show_tables = true;
    if (this_present_simplify_check_on_show_tables || that_present_simplify_check_on_show_tables) {
      if (!(this_present_simplify_check_on_show_tables && that_present_simplify_check_on_show_tables))
        return false;
      if (this.simplify_check_on_show_tables != that.simplify_check_on_show_tables)
        return false;
    }

    boolean this_present_mt_dop_auto_fallback = true;
    boolean that_present_mt_dop_auto_fallback = true;
    if (this_present_mt_dop_auto_fallback || that_present_mt_dop_auto_fallback) {
      if (!(this_present_mt_dop_auto_fallback && that_present_mt_dop_auto_fallback))
        return false;
      if (this.mt_dop_auto_fallback != that.mt_dop_auto_fallback)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_simplify_check_on_show_tables = true;
    list.add(present_simplify_check_on_show_tables);
    if (present_simplify_check_on_show_tables)
      list.add(simplify_check_on_show_tables);

    boolean present_mt_dop_auto_fallback = true;
    list.add(present_mt_dop_auto_fallback);
    if (present_mt_dop_auto_fallback)
      list.add(mt_dop_auto_fallback);
  ...
  public int compareTo(TBackendGflags other) {
    ...
    lastComparison = Boolean.valueOf(isSetSimplify_check_on_show_tables()).compareTo(other.isSetSimplify_check_on_show_tables());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSimplify_check_on_show_tables()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.simplify_check_on_show_tables, other.simplify_check_on_show_tables);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
    lastComparison = Boolean.valueOf(isSetMt_dop_auto_fallback()).compareTo(other.isSetMt_dop_auto_fallback());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMt_dop_auto_fallback()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.mt_dop_auto_fallback, other.mt_dop_auto_fallback);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("simplify_check_on_show_tables:");
    sb.append(this.simplify_check_on_show_tables);
    first = false;
    if (!first) sb.append(", ");
    sb.append("mt_dop_auto_fallback:");
    sb.append(this.mt_dop_auto_fallback);
    first = false;
    sb.append(")");
    return sb.toString();
  }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (sentry_config == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'sentry_config' was not present! Struct: " + toString());
    }
    // alas, we cannot check 'load_auth_to_local_rules' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'non_impala_java_vlog' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'impala_log_lvl' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'inc_stats_size_limit_bytes' because it's a primitive and you chose the non-beans generator.
    if (lineage_event_log_dir == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'lineage_event_log_dir' was not present! Struct: " + toString());
    }
    // alas, we cannot check 'load_catalog_in_background' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'num_metadata_loading_threads' because it's a primitive and you chose the non-beans generator.
    if (principal == null) {
    ...
    if (authorization_policy_provider_class == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'authorization_policy_provider_class' was not present! Struct: " + toString());
    }
    if (kudu_master_hosts == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'kudu_master_hosts' was not present! Struct: " + toString());
    }
    if (local_library_path == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'local_library_path' was not present! Struct: " + toString());
    }
    // alas, we cannot check 'read_size' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'kudu_operation_timeout_ms' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'initial_hms_cnxn_timeout_s' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'enable_stats_extrapolation' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'sentry_catalog_polling_frequency_s' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'max_hdfs_partitions_parallel_load' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'max_nonhdfs_partitions_parallel_load' because it's a primitive and you chose the non-beans generator.
    if (reserved_words_version == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'reserved_words_version' was not present! Struct: " + toString());
    }
    // alas, we cannot check 'max_filter_error_rate' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'min_buffer_size' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'enable_orc_scanner' because it's a primitive and you chose the non-beans generator.
    if (authorized_proxy_group_config == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'authorized_proxy_group_config' was not present! Struct: " + toString());
    }
    // alas, we cannot check 'use_local_catalog' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'disable_catalog_data_ops_debug_only' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'local_catalog_cache_mb' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'local_catalog_cache_expiration_s' because it's a primitive and you chose the non-beans generator.
    if (catalog_topic_mode == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'catalog_topic_mode' was not present! Struct: " + toString());
    }
    // alas, we cannot check 'invalidate_tables_timeout_s' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'invalidate_tables_on_memory_pressure' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'invalidate_tables_gc_old_gen_full_threshold' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'invalidate_tables_fraction_on_memory_pressure' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'local_catalog_max_fetch_retries' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'kudu_scanner_thread_estimated_bytes_per_column' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'kudu_scanner_thread_max_estimated_bytes' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'catalog_max_parallel_partial_fetch_rpc' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'catalog_partial_fetch_rpc_queue_timeout_s' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'exchg_node_buffer_size_bytes' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'kudu_mutation_buffer_size' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'kudu_error_buffer_size' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'hms_event_polling_interval_s' because it's a primitive and you chose the non-beans generator.
    if (impala_build_version == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'impala_build_version' was not present! Struct: " + toString());
    }
    if (authorization_factory_class == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'authorization_factory_class' was not present! Struct: " + toString());
    }
    // alas, we cannot check 'unlock_mt_dop' because it's a primitive and you chose the non-beans generator.
    if (ranger_service_type == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'ranger_service_type' was not present! Struct: " + toString());
    }
    if (ranger_app_id == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'ranger_app_id' was not present! Struct: " + toString());
    }
    if (authorization_provider == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'authorization_provider' was not present! Struct: " + toString());
    }
    // alas, we cannot check 'recursively_list_partitions' because it's a primitive and you chose the non-beans generator.
    if (query_event_hook_classes == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'query_event_hook_classes' was not present! Struct: " + toString());
    }
    // alas, we cannot check 'query_event_hook_nthreads' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'is_executor' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'use_dedicated_coordinator_estimates' because it's a primitive and you chose the non-beans generator.
    if (blacklisted_dbs == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'blacklisted_dbs' was not present! Struct: " + toString());
    }
    if (blacklisted_tables == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'blacklisted_tables' was not present! Struct: " + toString());
    }
    // alas, we cannot check 'unlock_zorder_sort' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'simplify_check_on_show_tables' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'mt_dop_auto_fallback' because it's a primitive and you chose the non-beans generator.
  ...
  private static class TBackendGflagsStandardScheme extends StandardScheme<TBackendGflags> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TBackendGflags struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 60: // SIMPLIFY_CHECK_ON_SHOW_TABLES
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.simplify_check_on_show_tables = iprot.readBool();
              struct.setSimplify_check_on_show_tablesIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
          case 61: // MT_DOP_AUTO_FALLBACK
            if (schemeField.type == org.apache.thrift.protocol.TType.BOOL) {
              struct.mt_dop_auto_fallback = iprot.readBool();
              struct.setMt_dop_auto_fallbackIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
      ...
      if (!struct.isSetLoad_auth_to_local_rules()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'load_auth_to_local_rules' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetNon_impala_java_vlog()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'non_impala_java_vlog' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetImpala_log_lvl()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'impala_log_lvl' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetInc_stats_size_limit_bytes()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'inc_stats_size_limit_bytes' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetLoad_catalog_in_background()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'load_catalog_in_background' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetNum_metadata_loading_threads()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'num_metadata_loading_threads' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetRead_size()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'read_size' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetKudu_operation_timeout_ms()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'kudu_operation_timeout_ms' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetInitial_hms_cnxn_timeout_s()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'initial_hms_cnxn_timeout_s' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetEnable_stats_extrapolation()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'enable_stats_extrapolation' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetSentry_catalog_polling_frequency_s()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'sentry_catalog_polling_frequency_s' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetMax_hdfs_partitions_parallel_load()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'max_hdfs_partitions_parallel_load' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetMax_nonhdfs_partitions_parallel_load()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'max_nonhdfs_partitions_parallel_load' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetMax_filter_error_rate()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'max_filter_error_rate' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetMin_buffer_size()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'min_buffer_size' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetEnable_orc_scanner()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'enable_orc_scanner' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetUse_local_catalog()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'use_local_catalog' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetDisable_catalog_data_ops_debug_only()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'disable_catalog_data_ops_debug_only' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetLocal_catalog_cache_mb()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'local_catalog_cache_mb' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetLocal_catalog_cache_expiration_s()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'local_catalog_cache_expiration_s' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetInvalidate_tables_timeout_s()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'invalidate_tables_timeout_s' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetInvalidate_tables_on_memory_pressure()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'invalidate_tables_on_memory_pressure' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetInvalidate_tables_gc_old_gen_full_threshold()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'invalidate_tables_gc_old_gen_full_threshold' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetInvalidate_tables_fraction_on_memory_pressure()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'invalidate_tables_fraction_on_memory_pressure' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetLocal_catalog_max_fetch_retries()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'local_catalog_max_fetch_retries' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetKudu_scanner_thread_estimated_bytes_per_column()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'kudu_scanner_thread_estimated_bytes_per_column' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetKudu_scanner_thread_max_estimated_bytes()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'kudu_scanner_thread_max_estimated_bytes' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetCatalog_max_parallel_partial_fetch_rpc()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'catalog_max_parallel_partial_fetch_rpc' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetCatalog_partial_fetch_rpc_queue_timeout_s()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'catalog_partial_fetch_rpc_queue_timeout_s' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetExchg_node_buffer_size_bytes()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'exchg_node_buffer_size_bytes' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetKudu_mutation_buffer_size()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'kudu_mutation_buffer_size' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetKudu_error_buffer_size()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'kudu_error_buffer_size' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetHms_event_polling_interval_s()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'hms_event_polling_interval_s' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetUnlock_mt_dop()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'unlock_mt_dop' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetRecursively_list_partitions()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'recursively_list_partitions' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetQuery_event_hook_nthreads()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'query_event_hook_nthreads' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetIs_executor()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'is_executor' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetUse_dedicated_coordinator_estimates()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'use_dedicated_coordinator_estimates' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetUnlock_zorder_sort()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'unlock_zorder_sort' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetSimplify_check_on_show_tables()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'simplify_check_on_show_tables' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetMt_dop_auto_fallback()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'mt_dop_auto_fallback' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TBackendGflags struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(SIMPLIFY_CHECK_ON_SHOW_TABLES_FIELD_DESC);
      oprot.writeBool(struct.simplify_check_on_show_tables);
      oprot.writeFieldEnd();
      oprot.writeFieldBegin(MT_DOP_AUTO_FALLBACK_FIELD_DESC);
      oprot.writeBool(struct.mt_dop_auto_fallback);
      oprot.writeFieldEnd();
