...
public class THdfsPartitionLocation implements org.apache.thrift.TBase<THdfsPartitionLocation, THdfsPartitionLocation._Fields>, java.io.Serializable, Cloneable, Comparable<THdfsPartitionLocation> {
  ...
  public int prefix_index; // required
  ...
  public THdfsPartitionLocation setSuffix(String suffix) {
    this.suffix = suffix;
    return this;
  }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'prefix_index' because it's a primitive and you chose the non-beans generator.
    if (suffix == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'suffix' was not present! Struct: " + toString());
    }
  ...
  private static class THdfsPartitionLocationStandardScheme extends StandardScheme<THdfsPartitionLocation> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, THdfsPartitionLocation struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetPrefix_index()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'prefix_index' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
