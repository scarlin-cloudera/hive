...
public class TBackendDescriptor implements org.apache.thrift.TBase<TBackendDescriptor, TBackendDescriptor._Fields>, java.io.Serializable, Cloneable, Comparable<TBackendDescriptor> {
  ...
  private static final org.apache.thrift.protocol.TField ADMISSION_SLOTS_FIELD_DESC = new org.apache.thrift.protocol.TField("admission_slots", org.apache.thrift.protocol.TType.I64, (short)11);
  ...
  public org.apache.impala.thrift.TNetworkAddress address; // required
  public String ip_address; // required
  public boolean is_coordinator; // required
  public boolean is_executor; // required
  public org.apache.impala.thrift.TNetworkAddress debug_http_address; // optional
  public boolean secure_webserver; // optional
  public org.apache.impala.thrift.TNetworkAddress krpc_address; // optional
  public long admit_mem_limit; // required
  public boolean is_quiescing; // required
  public List<TExecutorGroupDesc> executor_groups; // required
  public long admission_slots; // required
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    ADMISSION_SLOTS((short)11, "admission_slots");
  ...
  private static final int __ADMISSION_SLOTS_ISSET_ID = 5;
  ...
  static {
    ...
    tmpMap.put(_Fields.ADMISSION_SLOTS, new org.apache.thrift.meta_data.FieldMetaData("admission_slots", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.I64)));
    ...
    long admission_slots)
  {
    ...
    this.admission_slots = admission_slots;
    setAdmission_slotsIsSet(true);
  }
  ...
  public TBackendDescriptor(TBackendDescriptor other) {
    ...
    this.admission_slots = other.admission_slots;
  }
  ...
  public void clear() {
    ...
    setAdmission_slotsIsSet(false);
    this.admission_slots = 0;
  }
  ...
  public TBackendDescriptor setAddress(org.apache.impala.thrift.TNetworkAddress address) {
    this.address = address;
    return this;
  }
  ...
  public TBackendDescriptor setIs_coordinator(boolean is_coordinator) {
    this.is_coordinator = is_coordinator;
    setIs_coordinatorIsSet(true);
    return this;
  }
  ...
  public TBackendDescriptor setIs_executor(boolean is_executor) {
    this.is_executor = is_executor;
    setIs_executorIsSet(true);
    return this;
  }
  ...
  public TBackendDescriptor setDebug_http_address(org.apache.impala.thrift.TNetworkAddress debug_http_address) {
  ...
  public TBackendDescriptor setKrpc_address(org.apache.impala.thrift.TNetworkAddress krpc_address) {
  ...
  public TBackendDescriptor setAdmit_mem_limit(long admit_mem_limit) {
    this.admit_mem_limit = admit_mem_limit;
    setAdmit_mem_limitIsSet(true);
    return this;
  }
  ...
  public TBackendDescriptor setIs_quiescing(boolean is_quiescing) {
    this.is_quiescing = is_quiescing;
    setIs_quiescingIsSet(true);
    return this;
  }
  ...
  public TBackendDescriptor setExecutor_groups(List<TExecutorGroupDesc> executor_groups) {
    this.executor_groups = executor_groups;
    return this;
  }
  ...
  public long getAdmission_slots() {
    return this.admission_slots;
  }

  public TBackendDescriptor setAdmission_slots(long admission_slots) {
    this.admission_slots = admission_slots;
    setAdmission_slotsIsSet(true);
    return this;
  }

  public void unsetAdmission_slots() {
    __isset_bitfield = EncodingUtils.clearBit(__isset_bitfield, __ADMISSION_SLOTS_ISSET_ID);
  }

  /** Returns true if field admission_slots is set (has been assigned a value) and false otherwise */
  public boolean isSetAdmission_slots() {
    return EncodingUtils.testBit(__isset_bitfield, __ADMISSION_SLOTS_ISSET_ID);
  }

  public void setAdmission_slotsIsSet(boolean value) {
    __isset_bitfield = EncodingUtils.setBit(__isset_bitfield, __ADMISSION_SLOTS_ISSET_ID, value);
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case ADMISSION_SLOTS:
      if (value == null) {
        unsetAdmission_slots();
      } else {
        setAdmission_slots((Long)value);
      }
      break;
  ...
  public boolean equals(TBackendDescriptor that) {
    ...
    boolean this_present_admission_slots = true;
    boolean that_present_admission_slots = true;
    if (this_present_admission_slots || that_present_admission_slots) {
      if (!(this_present_admission_slots && that_present_admission_slots))
        return false;
      if (this.admission_slots != that.admission_slots)
        return false;
    }
  ...
  public int hashCode() {
    ...
    boolean present_admission_slots = true;
    list.add(present_admission_slots);
    if (present_admission_slots)
      list.add(admission_slots);
  ...
  public int compareTo(TBackendDescriptor other) {
    ...
    lastComparison = Boolean.valueOf(isSetAdmission_slots()).compareTo(other.isSetAdmission_slots());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetAdmission_slots()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.admission_slots, other.admission_slots);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    first = false;
    if (!first) sb.append(", ");
    sb.append("admission_slots:");
    sb.append(this.admission_slots);
    first = false;
    sb.append(")");
    return sb.toString();
  }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'is_coordinator' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'is_executor' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'admit_mem_limit' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'is_quiescing' because it's a primitive and you chose the non-beans generator.
    if (executor_groups == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'executor_groups' was not present! Struct: " + toString());
    }
    // alas, we cannot check 'admission_slots' because it's a primitive and you chose the non-beans generator.
  ...
  private static class TBackendDescriptorStandardScheme extends StandardScheme<TBackendDescriptor> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TBackendDescriptor struct) throws org.apache.thrift.TException {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 11: // ADMISSION_SLOTS
            if (schemeField.type == org.apache.thrift.protocol.TType.I64) {
              struct.admission_slots = iprot.readI64();
              struct.setAdmission_slotsIsSet(true);
            } else { 
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
      ...
      if (!struct.isSetIs_coordinator()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'is_coordinator' was not found in serialized data! Struct: " + toString());
      }
      ...
      if (!struct.isSetAdmit_mem_limit()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'admit_mem_limit' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetIs_quiescing()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'is_quiescing' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetAdmission_slots()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'admission_slots' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TBackendDescriptor struct) throws org.apache.thrift.TException {
      ...
      oprot.writeFieldBegin(ADMISSION_SLOTS_FIELD_DESC);
      oprot.writeI64(struct.admission_slots);
      oprot.writeFieldEnd();
