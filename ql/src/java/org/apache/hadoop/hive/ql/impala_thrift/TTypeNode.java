...
public class TTypeNode implements org.apache.thrift.TBase<TTypeNode, TTypeNode._Fields>, java.io.Serializable, Cloneable, Comparable<TTypeNode> {
  ...
  private TTypeNodeType type; // required
  private TScalarType scalar_type; // optional
  private List<TStructField> struct_fields; // optional
   ...
   * @see TTypeNodeType
   */
  public void setType(TTypeNodeType type) {
    this.type = type;
  }
  ...
  public void setScalar_type(TScalarType scalar_type) {
  ...
  public void setStruct_fields(List<TStructField> struct_fields) {
