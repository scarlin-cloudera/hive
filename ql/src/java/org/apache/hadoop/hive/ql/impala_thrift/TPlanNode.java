...
public class TPlanNode implements org.apache.thrift.TBase<TPlanNode, TPlanNode._Fields>, java.io.Serializable, Cloneable, Comparable<TPlanNode> {
  ...
  public List<org.apache.impala.thrift.TExpr> conjuncts; // optional
  public boolean disable_codegen; // required
  public List<TPipelineMembership> pipelines; // required
  ...
  public TNestedLoopJoinNode nested_loop_join_node; // optional
  ...
  public TUnnestNode unnest_node; // optional
  ...
  public List<TRuntimeFilterDesc> runtime_filters; // optional
  public org.apache.impala.thrift.TBackendResourceProfile resource_profile; // required
  public TCardinalityCheckNode cardinality_check_node; // optional
  ...
  public TPlanNode setConjuncts(List<org.apache.impala.thrift.TExpr> conjuncts) {
  ...
  public TPlanNode setDisable_codegen(boolean disable_codegen) {
    this.disable_codegen = disable_codegen;
    setDisable_codegenIsSet(true);
    return this;
  }
  ...
  public TPlanNode setPipelines(List<TPipelineMembership> pipelines) {
    this.pipelines = pipelines;
    return this;
  }
  ...
  public TPlanNode setNested_loop_join_node(TNestedLoopJoinNode nested_loop_join_node) {
  ...
  public TPlanNode setUnnest_node(TUnnestNode unnest_node) {
  ...
  public TPlanNode setEstimated_stats(org.apache.impala.thrift.TExecStats estimated_stats) {
  ...
  public TPlanNode setRuntime_filters(List<TRuntimeFilterDesc> runtime_filters) {
  ...
  public TPlanNode setResource_profile(org.apache.impala.thrift.TBackendResourceProfile resource_profile) {
    this.resource_profile = resource_profile;
    return this;
  }
  ...
  public TPlanNode setCardinality_check_node(TCardinalityCheckNode cardinality_check_node) {
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'disable_codegen' because it's a primitive and you chose the non-beans generator.
    if (pipelines == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'pipelines' was not present! Struct: " + toString());
    }
  ...
  private static class TPlanNodeStandardScheme extends StandardScheme<TPlanNode> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TPlanNode struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetDisable_codegen()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'disable_codegen' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
