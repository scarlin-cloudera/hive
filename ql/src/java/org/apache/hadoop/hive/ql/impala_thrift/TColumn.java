...
public class TColumn implements org.apache.thrift.TBase<TColumn, TColumn._Fields>, java.io.Serializable, Cloneable, Comparable<TColumn> {
  ...
  public org.apache.impala.thrift.TColumnType columnType; // required
  ...
  public boolean is_kudu_column; // optional
   ...
   * @see TColumnEncoding
   */
  public TColumnEncoding encoding; // optional
  /**
   * 
   * @see THdfsCompression
   */
  public THdfsCompression compression; // optional
  public org.apache.impala.thrift.TExpr default_value; // optional
  public int block_size; // optional
  public String kudu_column_name; // optional
  ...
  public TColumn setColumnType(org.apache.impala.thrift.TColumnType columnType) {
    this.columnType = columnType;
    return this;
  }
  ...
  public TColumn setIs_kudu_column(boolean is_kudu_column) {
  ...
  public TColumn setIs_nullable(boolean is_nullable) {
   ...
   * @see TColumnEncoding
   */
  public TColumn setEncoding(TColumnEncoding encoding) {
   ...
   * @see THdfsCompression
   */
  public TColumn setCompression(THdfsCompression compression) {
  ...
  public TColumn setDefault_value(org.apache.impala.thrift.TExpr default_value) {
  ...
  public TColumn setBlock_size(int block_size) {
  ...
  public TColumn setKudu_column_name(String kudu_column_name) {
