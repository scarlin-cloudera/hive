...
public class TPlanFragmentCtx implements org.apache.thrift.TBase<TPlanFragmentCtx, TPlanFragmentCtx._Fields>, java.io.Serializable, Cloneable, Comparable<TPlanFragmentCtx> {
  ...
  private org.apache.impala.thrift.TPlanFragment fragment; // required
  private List<TPlanFragmentDestination> destinations; // required
  ...
  public void setFragment(org.apache.impala.thrift.TPlanFragment fragment) {
    this.fragment = fragment;
  }
  ...
  public void setDestinations(List<TPlanFragmentDestination> destinations) {
    this.destinations = destinations;
  }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (!isSetFragment()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'fragment' is unset! Struct:" + toString());
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.destinations = new ArrayList<TPlanFragmentDestination>(_list24.size);
                TPlanFragmentDestination _elem25;
                for (int _i26 = 0; _i26 < _list24.size; ++_i26)
                {
                  _elem25 = new TPlanFragmentDestination();
                  _elem25.read(iprot);
                  struct.destinations.add(_elem25);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TPlanFragmentCtx struct) throws org.apache.thrift.TException {
      ...
      if (struct.destinations != null) {
        oprot.writeFieldBegin(DESTINATIONS_FIELD_DESC);
        {
          ...
          for (TPlanFragmentDestination _iter27 : struct.destinations)
          {
            _iter27.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetDestinations()) {
        {
          ...
          for (TPlanFragmentDestination _iter28 : struct.destinations)
          {
            _iter28.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.destinations = new ArrayList<TPlanFragmentDestination>(_list29.size);
          TPlanFragmentDestination _elem30;
          for (int _i31 = 0; _i31 < _list29.size; ++_i31)
          {
            _elem30 = new TPlanFragmentDestination();
            _elem30.read(iprot);
