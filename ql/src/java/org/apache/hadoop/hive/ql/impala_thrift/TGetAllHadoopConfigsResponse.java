...
public class TGetAllHadoopConfigsResponse implements org.apache.thrift.TBase<TGetAllHadoopConfigsResponse, TGetAllHadoopConfigsResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TGetAllHadoopConfigsResponse> {
  ...
  private Map<String,String> configs; // optional
  ...
  private static final _Fields optionals[] = {_Fields.CONFIGS};
  ...
  public TGetAllHadoopConfigsResponse(TGetAllHadoopConfigsResponse other) {
    if (other.isSetConfigs()) {
      Map<String,String> __this__configs = new HashMap<String,String>(other.configs);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.configs = new HashMap<String,String>(2*_map242.size);
                String _key243;
                String _val244;
                for (int _i245 = 0; _i245 < _map242.size; ++_i245)
                {
                  ...
                  struct.configs.put(_key243, _val244);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.configs != null) {
        if (struct.isSetConfigs()) {
          oprot.writeFieldBegin(CONFIGS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter246 : struct.configs.entrySet())
            {
      ...
      if (struct.isSetConfigs()) {
        {
          ...
          for (Map.Entry<String, String> _iter247 : struct.configs.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.configs = new HashMap<String,String>(2*_map248.size);
          String _key249;
          String _val250;
          for (int _i251 = 0; _i251 < _map248.size; ++_i251)
          {
            ...
            struct.configs.put(_key249, _val250);
          }
        }
        struct.setConfigsIsSet(true);
      }
