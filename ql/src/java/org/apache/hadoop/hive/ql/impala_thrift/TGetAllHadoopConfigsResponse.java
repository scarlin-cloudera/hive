            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.configs = new HashMap<String,String>(2*_map208.size);
                String _key209;
                String _val210;
                for (int _i211 = 0; _i211 < _map208.size; ++_i211)
                {
                  ...
                  struct.configs.put(_key209, _val210);
                }
                iprot.readMapEnd();
              }
      ...
      if (struct.configs != null) {
        if (struct.isSetConfigs()) {
          oprot.writeFieldBegin(CONFIGS_FIELD_DESC);
          {
            ...
            for (Map.Entry<String, String> _iter212 : struct.configs.entrySet())
            {
      ...
      if (struct.isSetConfigs()) {
        {
          ...
          for (Map.Entry<String, String> _iter213 : struct.configs.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.configs = new HashMap<String,String>(2*_map214.size);
          String _key215;
          String _val216;
          for (int _i217 = 0; _i217 < _map214.size; ++_i217)
          {
            ...
            struct.configs.put(_key215, _val216);
          }
        }
        struct.setConfigsIsSet(true);
      }
