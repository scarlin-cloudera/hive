...
public class TIntermediateColumnStats implements org.apache.thrift.TBase<TIntermediateColumnStats, TIntermediateColumnStats._Fields>, java.io.Serializable, Cloneable, Comparable<TIntermediateColumnStats> {
  ...
  private ByteBuffer intermediate_ndv; // optional
  private boolean is_ndv_encoded; // optional
  private long num_nulls; // optional
  private int max_width; // optional
  private double avg_width; // optional
  private long num_rows; // optional
  ...
  public void setIntermediate_ndv(byte[] intermediate_ndv) {
  ...
  public void setIntermediate_ndv(ByteBuffer intermediate_ndv) {
  ...
  public void setIs_ndv_encoded(boolean is_ndv_encoded) {
  ...
  public void setNum_nulls(long num_nulls) {
  ...
  public void setAvg_width(double avg_width) {
