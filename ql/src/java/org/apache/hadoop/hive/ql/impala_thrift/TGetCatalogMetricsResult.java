...
public class TGetCatalogMetricsResult implements org.apache.thrift.TBase<TGetCatalogMetricsResult, TGetCatalogMetricsResult._Fields>, java.io.Serializable, Cloneable, Comparable<TGetCatalogMetricsResult> {
  ...
  public int num_dbs; // required
  public int num_tables; // required
  public long cache_eviction_count; // optional
  public long cache_hit_count; // optional
  public long cache_load_count; // optional
  public long cache_load_exception_count; // optional
  public long cache_load_success_count; // optional
  public long cache_miss_count; // optional
  public long cache_request_count; // optional
  public long cache_total_load_time; // optional
  public double cache_avg_load_time; // optional
  public double cache_hit_rate; // optional
  public double cache_load_exception_rate; // optional
  public double cache_miss_rate; // optional
  ...
  public TGetCatalogMetricsResult setNum_dbs(int num_dbs) {
    this.num_dbs = num_dbs;
    setNum_dbsIsSet(true);
    return this;
  }
  ...
  public TGetCatalogMetricsResult setNum_tables(int num_tables) {
    this.num_tables = num_tables;
    setNum_tablesIsSet(true);
    return this;
  }
  ...
  public TGetCatalogMetricsResult setCache_eviction_count(long cache_eviction_count) {
  ...
  public TGetCatalogMetricsResult setCache_hit_count(long cache_hit_count) {
  ...
  public TGetCatalogMetricsResult setCache_load_count(long cache_load_count) {
  ...
  public TGetCatalogMetricsResult setCache_load_exception_count(long cache_load_exception_count) {
  ...
  public TGetCatalogMetricsResult setCache_load_success_count(long cache_load_success_count) {
  ...
  public TGetCatalogMetricsResult setCache_miss_count(long cache_miss_count) {
  ...
  public TGetCatalogMetricsResult setCache_request_count(long cache_request_count) {
  ...
  public TGetCatalogMetricsResult setCache_total_load_time(long cache_total_load_time) {
  ...
  public TGetCatalogMetricsResult setCache_avg_load_time(double cache_avg_load_time) {
  ...
  public TGetCatalogMetricsResult setCache_hit_rate(double cache_hit_rate) {
  ...
  public TGetCatalogMetricsResult setCache_load_exception_rate(double cache_load_exception_rate) {
  ...
  public TGetCatalogMetricsResult setCache_miss_rate(double cache_miss_rate) {
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'num_dbs' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'num_tables' because it's a primitive and you chose the non-beans generator.
  ...
  private static class TGetCatalogMetricsResultStandardScheme extends StandardScheme<TGetCatalogMetricsResult> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TGetCatalogMetricsResult struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetNum_dbs()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'num_dbs' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetNum_tables()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'num_tables' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
