...
public class ResultsMetadata implements org.apache.thrift.TBase<ResultsMetadata, ResultsMetadata._Fields>, java.io.Serializable, Cloneable, Comparable<ResultsMetadata> {
  ...
  public int compareTo(ResultsMetadata other) {
    ...
    lastComparison = Boolean.valueOf(isSetTable_dir()).compareTo(other.isSetTable_dir());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetTable_dir()) {
    ...
    lastComparison = Boolean.valueOf(isSetIn_tablename()).compareTo(other.isSetIn_tablename());
    if (lastComparison != 0) {
      return lastComparison;
    }
    ...
    lastComparison = Boolean.valueOf(isSetDelim()).compareTo(other.isSetDelim());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetDelim()) {
  ...
  private static class ResultsMetadataStandardScheme extends StandardScheme<ResultsMetadata> {
  ...
  private static class ResultsMetadataTupleScheme extends TupleScheme<ResultsMetadata> {
