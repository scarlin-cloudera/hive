...
public class TGetCatalogUsageResponse implements org.apache.thrift.TBase<TGetCatalogUsageResponse, TGetCatalogUsageResponse._Fields>, java.io.Serializable, Cloneable, Comparable<TGetCatalogUsageResponse> {
  ...
  public List<TTableUsageMetrics> large_tables; // required
  public List<TTableUsageMetrics> frequently_accessed_tables; // required
  public List<TTableUsageMetrics> high_file_count_tables; // required
  ...
  public TGetCatalogUsageResponse setLarge_tables(List<TTableUsageMetrics> large_tables) {
    this.large_tables = large_tables;
    return this;
  }
  ...
  public TGetCatalogUsageResponse setFrequently_accessed_tables(List<TTableUsageMetrics> frequently_accessed_tables) {
    this.frequently_accessed_tables = frequently_accessed_tables;
    return this;
  }
  ...
  public TGetCatalogUsageResponse setHigh_file_count_tables(List<TTableUsageMetrics> high_file_count_tables) {
    this.high_file_count_tables = high_file_count_tables;
    return this;
  }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (large_tables == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'large_tables' was not present! Struct: " + toString());
    }
    if (frequently_accessed_tables == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'frequently_accessed_tables' was not present! Struct: " + toString());
    }
    if (high_file_count_tables == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'high_file_count_tables' was not present! Struct: " + toString());
    }
