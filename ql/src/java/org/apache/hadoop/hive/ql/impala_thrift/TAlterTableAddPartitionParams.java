...
public class TAlterTableAddPartitionParams implements org.apache.thrift.TBase<TAlterTableAddPartitionParams, TAlterTableAddPartitionParams._Fields>, java.io.Serializable, Cloneable, Comparable<TAlterTableAddPartitionParams> {
  ...
  private static final org.apache.thrift.protocol.TField IF_NOT_EXISTS_FIELD_DESC = new org.apache.thrift.protocol.TField("if_not_exists", org.apache.thrift.protocol.TType.BOOL, (short)1);
  ...
  public List<TPartitionDef> partitions; // required

  /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    IF_NOT_EXISTS((short)1, "if_not_exists"),
  ...
  static {
    ...
    tmpMap.put(_Fields.PARTITIONS, new org.apache.thrift.meta_data.FieldMetaData("partitions", org.apache.thrift.TFieldRequirementType.REQUIRED, 
        new org.apache.thrift.meta_data.ListMetaData(org.apache.thrift.protocol.TType.LIST, 
            new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TPartitionDef.class))));
  ...
  public TAlterTableAddPartitionParams(TAlterTableAddPartitionParams other) {
    ...
    if (other.isSetPartitions()) {
      List<TPartitionDef> __this__partitions = new ArrayList<TPartitionDef>(other.partitions.size());
      for (TPartitionDef other_element : other.partitions) {
        __this__partitions.add(new TPartitionDef(other_element));
      }
  ...
  public java.util.Iterator<TPartitionDef> getPartitionsIterator() {
    return (this.partitions == null) ? null : this.partitions.iterator();
  }

  public void addToPartitions(TPartitionDef elem) {
    if (this.partitions == null) {
      this.partitions = new ArrayList<TPartitionDef>();
    }
    this.partitions.add(elem);
  }

  public List<TPartitionDef> getPartitions() {
    return this.partitions;
  }

  public TAlterTableAddPartitionParams setPartitions(List<TPartitionDef> partitions) {
    this.partitions = partitions;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case PARTITIONS:
      if (value == null) {
        ...
        setPartitions((List<TPartitionDef>)value);
      }
      break;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitions = new ArrayList<TPartitionDef>(_list40.size);
                TPartitionDef _elem41;
                for (int _i42 = 0; _i42 < _list40.size; ++_i42)
                {
                  _elem41 = new TPartitionDef();
                  _elem41.read(iprot);
                  struct.partitions.add(_elem41);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TAlterTableAddPartitionParams struct) throws org.apache.thrift.TException {
      ...
      if (struct.partitions != null) {
        oprot.writeFieldBegin(PARTITIONS_FIELD_DESC);
        {
          ...
          for (TPartitionDef _iter43 : struct.partitions)
          {
            _iter43.write(oprot);
          }
          oprot.writeListEnd();
  ...
  private static class TAlterTableAddPartitionParamsTupleScheme extends TupleScheme<TAlterTableAddPartitionParams> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TAlterTableAddPartitionParams struct) throws org.apache.thrift.TException {
      ...
      oprot.writeBool(struct.if_not_exists);
      {
        ...
        for (TPartitionDef _iter44 : struct.partitions)
        {
          _iter44.write(oprot);
        }
      }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TAlterTableAddPartitionParams struct) throws org.apache.thrift.TException {
      ...
      struct.setIf_not_existsIsSet(true);
      {
        ...
        struct.partitions = new ArrayList<TPartitionDef>(_list45.size);
        TPartitionDef _elem46;
        for (int _i47 = 0; _i47 < _list45.size; ++_i47)
        {
          _elem46 = new TPartitionDef();
          _elem46.read(iprot);
          struct.partitions.add(_elem46);
        }
      }
      struct.setPartitionsIsSet(true);
    }
