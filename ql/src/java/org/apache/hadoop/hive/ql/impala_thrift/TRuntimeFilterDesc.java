...
public class TRuntimeFilterDesc implements org.apache.thrift.TBase<TRuntimeFilterDesc, TRuntimeFilterDesc._Fields>, java.io.Serializable, Cloneable, Comparable<TRuntimeFilterDesc> {
  ...
  public org.apache.impala.thrift.TExpr src_expr; // required
  public List<TRuntimeFilterTargetDesc> targets; // required
  public Map<Integer,Integer> planid_to_target_ndx; // required
  ...
  public boolean applied_on_partition_columns; // required
  public long ndv_estimate; // optional
  /**
   * 
   * @see TRuntimeFilterType
   */
  public TRuntimeFilterType type; // required
  public long filter_size_bytes; // optional
  ...
  public TRuntimeFilterDesc setFilter_id(int filter_id) {
    this.filter_id = filter_id;
    setFilter_idIsSet(true);
    return this;
  }
  ...
  public TRuntimeFilterDesc setSrc_expr(org.apache.impala.thrift.TExpr src_expr) {
    this.src_expr = src_expr;
    return this;
  }
  ...
  public TRuntimeFilterDesc setTargets(List<TRuntimeFilterTargetDesc> targets) {
    this.targets = targets;
    return this;
  }
  ...
  public TRuntimeFilterDesc setPlanid_to_target_ndx(Map<Integer,Integer> planid_to_target_ndx) {
    this.planid_to_target_ndx = planid_to_target_ndx;
    return this;
  }
  ...
  public TRuntimeFilterDesc setIs_broadcast_join(boolean is_broadcast_join) {
    this.is_broadcast_join = is_broadcast_join;
    setIs_broadcast_joinIsSet(true);
    return this;
  }
  ...
  public TRuntimeFilterDesc setHas_local_targets(boolean has_local_targets) {
    this.has_local_targets = has_local_targets;
    setHas_local_targetsIsSet(true);
    return this;
  }
  ...
  public TRuntimeFilterDesc setHas_remote_targets(boolean has_remote_targets) {
    this.has_remote_targets = has_remote_targets;
    setHas_remote_targetsIsSet(true);
    return this;
  }
  ...
  public TRuntimeFilterDesc setApplied_on_partition_columns(boolean applied_on_partition_columns) {
    this.applied_on_partition_columns = applied_on_partition_columns;
    setApplied_on_partition_columnsIsSet(true);
    return this;
  }
  ...
  public TRuntimeFilterDesc setNdv_estimate(long ndv_estimate) {
   ...
   * @see TRuntimeFilterType
   */
  public TRuntimeFilterDesc setType(TRuntimeFilterType type) {
    this.type = type;
    return this;
  }
  ...
  public TRuntimeFilterDesc setFilter_size_bytes(long filter_size_bytes) {
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (planid_to_target_ndx == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'planid_to_target_ndx' was not present! Struct: " + toString());
    }
    ...
    // alas, we cannot check 'applied_on_partition_columns' because it's a primitive and you chose the non-beans generator.
    if (type == null) {
  ...
  private static class TRuntimeFilterDescStandardScheme extends StandardScheme<TRuntimeFilterDesc> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TRuntimeFilterDesc struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetIs_broadcast_join()) {
      ...
      if (!struct.isSetHas_local_targets()) {
      ...
      if (!struct.isSetApplied_on_partition_columns()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'applied_on_partition_columns' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
