...
public class TCatalogObject implements org.apache.thrift.TBase<TCatalogObject, TCatalogObject._Fields>, java.io.Serializable, Cloneable, Comparable<TCatalogObject> {
  ...
  private TCatalogObjectType type; // required
  private long catalog_version; // required
  private TCatalog catalog; // optional
  private TDatabase db; // optional
  private TTable table; // optional
  private org.apache.impala.thrift.TFunction fn; // optional
  private TDataSource data_source; // optional
  private TPrincipal principal; // optional
  private TPrivilege privilege; // optional
  private THdfsCachePool cache_pool; // optional
  private TAuthzCacheInvalidation authz_cache_invalidation; // optional
   ...
   * @see TCatalogObjectType
   */
  public void setType(TCatalogObjectType type) {
    this.type = type;
  }
  ...
  public void setCatalog_version(long catalog_version) {
    this.catalog_version = catalog_version;
    setCatalog_versionIsSet(true);
  }
  ...
  public void setDb(TDatabase db) {
    this.db = db;
  }
  ...
  public void setData_source(TDataSource data_source) {
  ...
  public void setPrincipal(TPrincipal principal) {
  ...
  public void setCache_pool(THdfsCachePool cache_pool) {
  ...
  public void setAuthz_cache_invalidation(TAuthzCacheInvalidation authz_cache_invalidation) {
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (!isSetCatalog_version()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'catalog_version' is unset! Struct:" + toString());
    }
