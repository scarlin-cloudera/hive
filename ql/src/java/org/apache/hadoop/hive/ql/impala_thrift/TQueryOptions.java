...
public class TQueryOptions implements org.apache.thrift.TBase<TQueryOptions, TQueryOptions._Fields>, java.io.Serializable, Cloneable, Comparable<TQueryOptions> {
  ...
  public org.apache.impala.thrift.TCompressionCodec compression_codec; // optional
   ...
   */
  public org.apache.impala.thrift.TExplainLevel explain_level; // optional
  ...
  public boolean optimize_partition_key_scans; // optional
  /**
   * 
   * @see org.apache.impala.thrift.TReplicaPreference
   */
  public org.apache.impala.thrift.TReplicaPreference replica_preference; // optional
  public boolean schedule_random_replica; // optional
  public boolean disable_streaming_preaggregations; // optional
  /**
   * 
   * @see org.apache.impala.thrift.TRuntimeFilterMode
   */
  public org.apache.impala.thrift.TRuntimeFilterMode runtime_filter_mode; // optional
  public int runtime_bloom_filter_size; // optional
  public int runtime_filter_wait_time_ms; // optional
  public boolean disable_row_runtime_filtering; // optional
  public int max_num_runtime_filters; // optional
  public boolean parquet_annotate_strings_utf8; // optional
  /**
   * 
   * @see TParquetFallbackSchemaResolution
   */
  public TParquetFallbackSchemaResolution parquet_fallback_schema_resolution; // optional
  public int mt_dop; // optional
  public boolean s3_skip_insert_staging; // optional
  public int runtime_filter_min_size; // optional
  public int runtime_filter_max_size; // optional
  /**
   * 
   * @see org.apache.impala.thrift.TPrefetchMode
   */
  public org.apache.impala.thrift.TPrefetchMode prefetch_mode; // optional
  public boolean strict_mode; // optional
  public long scratch_limit; // optional
  public boolean enable_expr_rewrites; // optional
  public boolean decimal_v2; // optional
  public boolean parquet_dictionary_filtering; // optional
  /**
   * 
   * @see TParquetArrayResolution
   */
  public TParquetArrayResolution parquet_array_resolution; // optional
  public boolean parquet_read_statistics; // optional
  /**
   * 
   * @see TJoinDistributionMode
   */
  public TJoinDistributionMode default_join_distribution_mode; // optional
  public int disable_codegen_rows_threshold; // optional
  ...
  public int idle_session_timeout; // optional
  public long compute_stats_min_sample_size; // optional
  public int exec_time_limit_s; // optional
  public boolean shuffle_distinct_exprs; // optional
  public long max_mem_estimate_for_admission; // optional
  public int thread_reservation_limit; // optional
  public int thread_reservation_aggregate_limit; // optional
  /**
   * 
   * @see TKuduReadMode
   */
  public TKuduReadMode kudu_read_mode; // optional
  public boolean allow_erasure_coded_files; // optional
  public String timezone; // optional
  public long scan_bytes_limit; // optional
  public long cpu_limit_s; // optional
  public long topn_bytes_limit; // optional
  public String client_identifier; // optional
  public double resource_trace_ratio; // optional
  public int num_remote_executor_candidates; // optional
  public long num_rows_produced_limit; // optional
  public boolean planner_testcase_mode; // optional
  /**
   * 
   * @see org.apache.impala.thrift.THdfsFileFormat
   */
  public org.apache.impala.thrift.THdfsFileFormat default_file_format; // optional
  /**
   * 
   * @see TParquetTimestampType
   */
  public TParquetTimestampType parquet_timestamp_type; // optional
  public boolean parquet_read_page_index; // optional
  public boolean parquet_write_page_index; // optional
  public int parquet_page_row_count_limit; // optional
  public boolean disable_hdfs_num_rows_estimate; // optional
  public String default_hints_insert_statement; // optional
  public boolean spool_query_results; // optional
  /**
   * 
   * @see TTransactionalType
   */
  public TTransactionalType default_transactional_type; // optional
  public int statement_expression_limit; // optional
  public int max_statement_length_bytes; // optional
  public boolean disable_data_cache; // optional
  public long max_result_spooling_mem; // optional
  public long max_spilled_result_spooling_mem; // optional
  public boolean disable_hbase_num_rows_estimate; // optional
  public long fetch_rows_timeout_ms; // optional
  public String now_string; // optional
  public long parquet_object_store_split_size; // optional
  public long mem_limit_executors; // optional
  ...
  public TQueryOptions setCompression_codec(org.apache.impala.thrift.TCompressionCodec compression_codec) {
   ...
   * @see org.apache.impala.thrift.TExplainLevel
   */
  public TQueryOptions setExplain_level(org.apache.impala.thrift.TExplainLevel explain_level) {
  ...
  public TQueryOptions setBuffer_pool_limit(long buffer_pool_limit) {
  ...
  public TQueryOptions setOptimize_partition_key_scans(boolean optimize_partition_key_scans) {
   ...
   * @see org.apache.impala.thrift.TReplicaPreference
   */
  public TQueryOptions setReplica_preference(org.apache.impala.thrift.TReplicaPreference replica_preference) {
  ...
  public TQueryOptions setSchedule_random_replica(boolean schedule_random_replica) {
  ...
  public TQueryOptions setDisable_streaming_preaggregations(boolean disable_streaming_preaggregations) {
   ...
   * @see org.apache.impala.thrift.TRuntimeFilterMode
   */
  public TQueryOptions setRuntime_filter_mode(org.apache.impala.thrift.TRuntimeFilterMode runtime_filter_mode) {
  ...
  public TQueryOptions setRuntime_bloom_filter_size(int runtime_bloom_filter_size) {
  ...
  public TQueryOptions setRuntime_filter_wait_time_ms(int runtime_filter_wait_time_ms) {
  ...
  public TQueryOptions setDisable_row_runtime_filtering(boolean disable_row_runtime_filtering) {
  ...
  public TQueryOptions setMax_num_runtime_filters(int max_num_runtime_filters) {
  ...
  public TQueryOptions setParquet_annotate_strings_utf8(boolean parquet_annotate_strings_utf8) {
   ...
   * @see TParquetFallbackSchemaResolution
   */
  public TQueryOptions setParquet_fallback_schema_resolution(TParquetFallbackSchemaResolution parquet_fallback_schema_resolution) {
  ...
  public TQueryOptions setMt_dop(int mt_dop) {
    this.mt_dop = mt_dop;
    setMt_dopIsSet(true);
    return this;
  }
  ...
  public TQueryOptions setS3_skip_insert_staging(boolean s3_skip_insert_staging) {
  ...
  public TQueryOptions setRuntime_filter_min_size(int runtime_filter_min_size) {
  ...
  public TQueryOptions setRuntime_filter_max_size(int runtime_filter_max_size) {
   ...
   * @see org.apache.impala.thrift.TPrefetchMode
   */
  public TQueryOptions setPrefetch_mode(org.apache.impala.thrift.TPrefetchMode prefetch_mode) {
  ...
  public TQueryOptions setStrict_mode(boolean strict_mode) {
  ...
  public TQueryOptions setScratch_limit(long scratch_limit) {
  ...
  public TQueryOptions setEnable_expr_rewrites(boolean enable_expr_rewrites) {
  ...
  public TQueryOptions setDecimal_v2(boolean decimal_v2) {
  ...
  public TQueryOptions setParquet_dictionary_filtering(boolean parquet_dictionary_filtering) {
   ...
   * @see TParquetArrayResolution
   */
  public TQueryOptions setParquet_array_resolution(TParquetArrayResolution parquet_array_resolution) {
  ...
  public TQueryOptions setParquet_read_statistics(boolean parquet_read_statistics) {
   ...
   * @see TJoinDistributionMode
   */
  public TQueryOptions setDefault_join_distribution_mode(TJoinDistributionMode default_join_distribution_mode) {
  ...
  public TQueryOptions setDisable_codegen_rows_threshold(int disable_codegen_rows_threshold) {
  ...
  public TQueryOptions setDefault_spillable_buffer_size(long default_spillable_buffer_size) {
  ...
  public TQueryOptions setMin_spillable_buffer_size(long min_spillable_buffer_size) {
  ...
  public TQueryOptions setMax_row_size(long max_row_size) {
  ...
  public TQueryOptions setIdle_session_timeout(int idle_session_timeout) {
  ...
  public TQueryOptions setCompute_stats_min_sample_size(long compute_stats_min_sample_size) {
  ...
  public TQueryOptions setExec_time_limit_s(int exec_time_limit_s) {
  ...
  public TQueryOptions setShuffle_distinct_exprs(boolean shuffle_distinct_exprs) {
  ...
  public TQueryOptions setMax_mem_estimate_for_admission(long max_mem_estimate_for_admission) {
  ...
  public TQueryOptions setThread_reservation_limit(int thread_reservation_limit) {
  ...
  public TQueryOptions setThread_reservation_aggregate_limit(int thread_reservation_aggregate_limit) {
   ...
   * @see TKuduReadMode
   */
  public TQueryOptions setKudu_read_mode(TKuduReadMode kudu_read_mode) {
  ...
  public TQueryOptions setAllow_erasure_coded_files(boolean allow_erasure_coded_files) {
  ...
  public TQueryOptions setTimezone(String timezone) {
  ...
  public TQueryOptions setScan_bytes_limit(long scan_bytes_limit) {
  ...
  public TQueryOptions setCpu_limit_s(long cpu_limit_s) {
  ...
  public TQueryOptions setTopn_bytes_limit(long topn_bytes_limit) {
  ...
  public TQueryOptions setClient_identifier(String client_identifier) {
  ...
  public TQueryOptions setResource_trace_ratio(double resource_trace_ratio) {
  ...
  public TQueryOptions setNum_remote_executor_candidates(int num_remote_executor_candidates) {
  ...
  public TQueryOptions setNum_rows_produced_limit(long num_rows_produced_limit) {
  ...
  public TQueryOptions setPlanner_testcase_mode(boolean planner_testcase_mode) {
   ...
   * @see org.apache.impala.thrift.THdfsFileFormat
   */
  public TQueryOptions setDefault_file_format(org.apache.impala.thrift.THdfsFileFormat default_file_format) {
   ...
   * @see TParquetTimestampType
   */
  public TQueryOptions setParquet_timestamp_type(TParquetTimestampType parquet_timestamp_type) {
  ...
  public TQueryOptions setParquet_read_page_index(boolean parquet_read_page_index) {
  ...
  public TQueryOptions setParquet_write_page_index(boolean parquet_write_page_index) {
  ...
  public TQueryOptions setParquet_page_row_count_limit(int parquet_page_row_count_limit) {
  ...
  public TQueryOptions setDisable_hdfs_num_rows_estimate(boolean disable_hdfs_num_rows_estimate) {
  ...
  public TQueryOptions setDefault_hints_insert_statement(String default_hints_insert_statement) {
  ...
  public TQueryOptions setSpool_query_results(boolean spool_query_results) {
   ...
   * @see TTransactionalType
   */
  public TQueryOptions setDefault_transactional_type(TTransactionalType default_transactional_type) {
  ...
  public TQueryOptions setStatement_expression_limit(int statement_expression_limit) {
  ...
  public TQueryOptions setMax_statement_length_bytes(int max_statement_length_bytes) {
  ...
  public TQueryOptions setDisable_data_cache(boolean disable_data_cache) {
  ...
  public TQueryOptions setMax_result_spooling_mem(long max_result_spooling_mem) {
  ...
  public TQueryOptions setMax_spilled_result_spooling_mem(long max_spilled_result_spooling_mem) {
  ...
  public TQueryOptions setDisable_hbase_num_rows_estimate(boolean disable_hbase_num_rows_estimate) {
  ...
  public TQueryOptions setFetch_rows_timeout_ms(long fetch_rows_timeout_ms) {
  ...
  public TQueryOptions setNow_string(String now_string) {
  ...
  public TQueryOptions setParquet_object_store_split_size(long parquet_object_store_split_size) {
  ...
  public TQueryOptions setMem_limit_executors(long mem_limit_executors) {
