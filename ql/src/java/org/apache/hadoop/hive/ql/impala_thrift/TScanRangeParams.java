...
public class TScanRangeParams implements org.apache.thrift.TBase<TScanRangeParams, TScanRangeParams._Fields>, java.io.Serializable, Cloneable, Comparable<TScanRangeParams> {
  ...
  public boolean try_hdfs_cache; // optional
  ...
  public TScanRangeParams setScan_range(org.apache.impala.thrift.TScanRange scan_range) {
    this.scan_range = scan_range;
    return this;
  }
  ...
  public TScanRangeParams setTry_hdfs_cache(boolean try_hdfs_cache) {
