...
public class TColumnStats implements org.apache.thrift.TBase<TColumnStats, TColumnStats._Fields>, java.io.Serializable, Cloneable, Comparable<TColumnStats> {
  ...
  private double avg_size; // required
  private long max_size; // required
  private long num_distinct_values; // required
  private long num_nulls; // required
  ...
  public void setNum_distinct_values(long num_distinct_values) {
    this.num_distinct_values = num_distinct_values;
    setNum_distinct_valuesIsSet(true);
  }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (!isSetAvg_size()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'avg_size' is unset! Struct:" + toString());
    }

    if (!isSetMax_size()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'max_size' is unset! Struct:" + toString());
    }

    if (!isSetNum_distinct_values()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'num_distinct_values' is unset! Struct:" + toString());
    }

    if (!isSetNum_nulls()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'num_nulls' is unset! Struct:" + toString());
    }
