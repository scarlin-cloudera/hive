...
public class TPartialPartitionInfo implements org.apache.thrift.TBase<TPartialPartitionInfo, TPartialPartitionInfo._Fields>, java.io.Serializable, Cloneable, Comparable<TPartialPartitionInfo> {
  ...
  public org.apache.hadoop.hive.metastore.api.Partition hms_partition; // optional
  public List<org.apache.impala.thrift.THdfsFileDesc> file_descriptors; // optional
  ...
  public TPartialPartitionInfo setId(long id) {
    this.id = id;
    setIdIsSet(true);
    return this;
  }
  ...
  public TPartialPartitionInfo setName(String name) {
    this.name = name;
    return this;
  }
  ...
  public TPartialPartitionInfo setHms_partition(org.apache.hadoop.hive.metastore.api.Partition hms_partition) {
  ...
  public TPartialPartitionInfo setFile_descriptors(List<org.apache.impala.thrift.THdfsFileDesc> file_descriptors) {
  ...
  public TPartialPartitionInfo setPartition_stats(byte[] partition_stats) {
  ...
  public TPartialPartitionInfo setPartition_stats(ByteBuffer partition_stats) {
  ...
  public TPartialPartitionInfo setHas_incremental_stats(boolean has_incremental_stats) {
