...
public class TDropTableOrViewParams implements org.apache.thrift.TBase<TDropTableOrViewParams, TDropTableOrViewParams._Fields>, java.io.Serializable, Cloneable, Comparable<TDropTableOrViewParams> {
  ...
  public boolean is_table; // optional
  ...
  public TDropTableOrViewParams setTable_name(org.apache.impala.thrift.TTableName table_name) {
    this.table_name = table_name;
    return this;
  }
  ...
  public TDropTableOrViewParams setPurge(boolean purge) {
    this.purge = purge;
    setPurgeIsSet(true);
    return this;
  }
  ...
  public TDropTableOrViewParams setIs_table(boolean is_table) {
  ...
  public TDropTableOrViewParams setServer_name(String server_name) {
