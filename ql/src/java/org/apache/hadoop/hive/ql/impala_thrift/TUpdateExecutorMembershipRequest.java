...
public class TUpdateExecutorMembershipRequest implements org.apache.thrift.TBase<TUpdateExecutorMembershipRequest, TUpdateExecutorMembershipRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TUpdateExecutorMembershipRequest> {
  ...
  private Set<String> hostnames; // required
  private Set<String> ip_addresses; // required
  ...
  public void setIp_addresses(Set<String> ip_addresses) {
    this.ip_addresses = ip_addresses;
  }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (!isSetHostnames()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'hostnames' is unset! Struct:" + toString());
    }

    if (!isSetIp_addresses()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'ip_addresses' is unset! Struct:" + toString());
    }
        ...
        switch (schemeField.id) {
          case 1: // HOSTNAMES
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set210 = iprot.readSetBegin();
                struct.hostnames = new HashSet<String>(2*_set210.size);
                String _elem211;
                for (int _i212 = 0; _i212 < _set210.size; ++_i212)
                {
                  _elem211 = iprot.readString();
                  struct.hostnames.add(_elem211);
                }
                iprot.readSetEnd();
              }
          ...
          case 2: // IP_ADDRESSES
            if (schemeField.type == org.apache.thrift.protocol.TType.SET) {
              {
                org.apache.thrift.protocol.TSet _set213 = iprot.readSetBegin();
                struct.ip_addresses = new HashSet<String>(2*_set213.size);
                String _elem214;
                for (int _i215 = 0; _i215 < _set213.size; ++_i215)
                {
                  _elem214 = iprot.readString();
                  struct.ip_addresses.add(_elem214);
                }
                iprot.readSetEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TUpdateExecutorMembershipRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.hostnames != null) {
        oprot.writeFieldBegin(HOSTNAMES_FIELD_DESC);
        {
          ...
          for (String _iter216 : struct.hostnames)
          {
      ...
      if (struct.ip_addresses != null) {
        oprot.writeFieldBegin(IP_ADDRESSES_FIELD_DESC);
        {
          ...
          for (String _iter217 : struct.ip_addresses)
          {
  ...
  private static class TUpdateExecutorMembershipRequestTupleScheme extends TupleScheme<TUpdateExecutorMembershipRequest> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TUpdateExecutorMembershipRequest struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (String _iter218 : struct.hostnames)
        {
      ...
      }
      {
        ...
        for (String _iter219 : struct.ip_addresses)
        {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TUpdateExecutorMembershipRequest struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TSet _set220 = new org.apache.thrift.protocol.TSet(org.apache.thrift.protocol.TType.STRING, iprot.readI32());
        struct.hostnames = new HashSet<String>(2*_set220.size);
        String _elem221;
        for (int _i222 = 0; _i222 < _set220.size; ++_i222)
        {
          _elem221 = iprot.readString();
          struct.hostnames.add(_elem221);
        }
      }
      struct.setHostnamesIsSet(true);
      {
        ...
        struct.ip_addresses = new HashSet<String>(2*_set223.size);
        String _elem224;
        for (int _i225 = 0; _i225 < _set223.size; ++_i225)
        {
          _elem224 = iprot.readString();
          struct.ip_addresses.add(_elem224);
        }
      }
      struct.setIp_addressesIsSet(true);
