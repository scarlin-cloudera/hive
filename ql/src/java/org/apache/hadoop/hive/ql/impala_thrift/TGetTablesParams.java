...
public class TGetTablesParams implements org.apache.thrift.TBase<TGetTablesParams, TGetTablesParams._Fields>, java.io.Serializable, Cloneable, Comparable<TGetTablesParams> {
  ...
  static {
    schemes.put(StandardScheme.class, new TGetTablesParamsStandardSchemeFactory());
    schemes.put(TupleScheme.class, new TGetTablesParamsTupleSchemeFactory());
  }
  ...
  public TGetTablesParams setDb(String db) {
    this.db = db;
    return this;
  }
  ...
  public TGetTablesParams setPattern(String pattern) {
  ...
  public TGetTablesParams setSession(org.apache.impala.thrift.TSessionState session) {
  ...
  private static class TGetTablesParamsStandardScheme extends StandardScheme<TGetTablesParams> {
  ...
  private static class TGetTablesParamsTupleScheme extends TupleScheme<TGetTablesParams> {
