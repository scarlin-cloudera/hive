...
public class TAggregationNode implements org.apache.thrift.TBase<TAggregationNode, TAggregationNode._Fields>, java.io.Serializable, Cloneable, Comparable<TAggregationNode> {
  ...
  public List<TAggregator> aggregators; // required
  public long estimated_input_cardinality; // required
  public boolean replicate_input; // required
  ...
  public TAggregationNode setAggregators(List<TAggregator> aggregators) {
    this.aggregators = aggregators;
    return this;
  }
  ...
  public TAggregationNode setEstimated_input_cardinality(long estimated_input_cardinality) {
    this.estimated_input_cardinality = estimated_input_cardinality;
    setEstimated_input_cardinalityIsSet(true);
    return this;
  }
  ...
  public TAggregationNode setReplicate_input(boolean replicate_input) {
    this.replicate_input = replicate_input;
    setReplicate_inputIsSet(true);
    return this;
  }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (aggregators == null) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'aggregators' was not present! Struct: " + toString());
    }
    // alas, we cannot check 'estimated_input_cardinality' because it's a primitive and you chose the non-beans generator.
    // alas, we cannot check 'replicate_input' because it's a primitive and you chose the non-beans generator.
  ...
  private static class TAggregationNodeStandardScheme extends StandardScheme<TAggregationNode> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TAggregationNode struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetEstimated_input_cardinality()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'estimated_input_cardinality' was not found in serialized data! Struct: " + toString());
      }
      if (!struct.isSetReplicate_input()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'replicate_input' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
