...
public class TExecSummary implements org.apache.thrift.TBase<TExecSummary, TExecSummary._Fields>, java.io.Serializable, Cloneable, Comparable<TExecSummary> {
  ...
  public String queued_reason; // optional
  ...
  public TExecSummary setStatus(org.apache.impala.thrift.TStatus status) {
    this.status = status;
    return this;
  }
  ...
  public TExecSummary setQueued_reason(String queued_reason) {
