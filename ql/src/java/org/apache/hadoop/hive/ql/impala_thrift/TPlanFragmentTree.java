...
public class TPlanFragmentTree implements org.apache.thrift.TBase<TPlanFragmentTree, TPlanFragmentTree._Fields>, java.io.Serializable, Cloneable, Comparable<TPlanFragmentTree> {
  ...
  public int cohort_id; // required
  public List<TPlanFragment> fragments; // required
  ...
  public TPlanFragmentTree setCohort_id(int cohort_id) {
    this.cohort_id = cohort_id;
    setCohort_idIsSet(true);
    return this;
  }
  ...
  public TPlanFragmentTree setFragments(List<TPlanFragment> fragments) {
    this.fragments = fragments;
    return this;
  }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'cohort_id' because it's a primitive and you chose the non-beans generator.
    if (fragments == null) {
  ...
  private static class TPlanFragmentTreeStandardScheme extends StandardScheme<TPlanFragmentTree> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TPlanFragmentTree struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetCohort_id()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'cohort_id' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
