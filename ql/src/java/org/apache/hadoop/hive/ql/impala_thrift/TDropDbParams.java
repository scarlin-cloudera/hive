...
public class TDropDbParams implements org.apache.thrift.TBase<TDropDbParams, TDropDbParams._Fields>, java.io.Serializable, Cloneable, Comparable<TDropDbParams> {
  ...
  public TDropDbParams setCascade(boolean cascade) {
    this.cascade = cascade;
    setCascadeIsSet(true);
    return this;
  }
  ...
  public TDropDbParams setServer_name(String server_name) {
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    // alas, we cannot check 'cascade' because it's a primitive and you chose the non-beans generator.
  ...
  private static class TDropDbParamsStandardScheme extends StandardScheme<TDropDbParams> {
    ...
    public void read(org.apache.thrift.protocol.TProtocol iprot, TDropDbParams struct) throws org.apache.thrift.TException {
      ...
      if (!struct.isSetCascade()) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'cascade' was not found in serialized data! Struct: " + toString());
      }
      struct.validate();
    }
