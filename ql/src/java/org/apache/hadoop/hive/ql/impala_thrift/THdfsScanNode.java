...
public class THdfsScanNode implements org.apache.thrift.TBase<THdfsScanNode, THdfsScanNode._Fields>, java.io.Serializable, Cloneable, Comparable<THdfsScanNode> {
  ...
  private Map<Integer,List<org.apache.impala.thrift.TExpr>> collection_conjuncts; // optional
  private TReplicaPreference replica_preference; // optional
  private boolean random_replica; // optional
  private int skip_header_line_count; // optional
  private boolean use_mt_scan_node; // optional
  private List<org.apache.impala.thrift.TExpr> min_max_conjuncts; // optional
  private int min_max_tuple_id; // optional
  private Map<Integer,List<Integer>> dictionary_filter_conjuncts; // optional
  private int parquet_count_star_slot_offset; // optional
  ...
  public void setCollection_conjuncts(Map<Integer,List<org.apache.impala.thrift.TExpr>> collection_conjuncts) {
   ...
   * @see TReplicaPreference
   */
  public void setReplica_preference(TReplicaPreference replica_preference) {
  ...
  public void setRandom_replica(boolean random_replica) {
  ...
  public void setSkip_header_line_count(int skip_header_line_count) {
  ...
  public void setMin_max_conjuncts(List<org.apache.impala.thrift.TExpr> min_max_conjuncts) {
  ...
  public void setMin_max_tuple_id(int min_max_tuple_id) {
  ...
  public void setDictionary_filter_conjuncts(Map<Integer,List<Integer>> dictionary_filter_conjuncts) {
  ...
  public void setParquet_count_star_slot_offset(int parquet_count_star_slot_offset) {
