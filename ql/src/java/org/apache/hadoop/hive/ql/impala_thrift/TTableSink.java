...
public class TTableSink implements org.apache.thrift.TBase<TTableSink, TTableSink._Fields>, java.io.Serializable, Cloneable, Comparable<TTableSink> {
   ...
   * @see TSinkAction
   */
  public TSinkAction action; // required
  public THdfsTableSink hdfs_table_sink; // optional
  public TKuduTableSink kudu_table_sink; // optional
   ...
   * @see TSinkAction
   */
  public TTableSink setAction(TSinkAction action) {
    this.action = action;
    return this;
  }
  ...
  public TTableSink setKudu_table_sink(TKuduTableSink kudu_table_sink) {
