...
public class TAggregator implements org.apache.thrift.TBase<TAggregator, TAggregator._Fields>, java.io.Serializable, Cloneable, Comparable<TAggregator> {
  ...
  private List<org.apache.impala.thrift.TExpr> grouping_exprs; // optional
  private List<org.apache.impala.thrift.TExpr> aggregate_functions; // required
  private int intermediate_tuple_id; // required
  private int output_tuple_id; // required
  private boolean need_finalize; // required
  private boolean use_streaming_preaggregation; // required
  ...
  public void setGrouping_exprs(List<org.apache.impala.thrift.TExpr> grouping_exprs) {
  ...
  public void setAggregate_functions(List<org.apache.impala.thrift.TExpr> aggregate_functions) {
    this.aggregate_functions = aggregate_functions;
  }
  ...
  public void setNeed_finalize(boolean need_finalize) {
    this.need_finalize = need_finalize;
    setNeed_finalizeIsSet(true);
  }
  ...
  public void setUse_streaming_preaggregation(boolean use_streaming_preaggregation) {
    this.use_streaming_preaggregation = use_streaming_preaggregation;
    setUse_streaming_preaggregationIsSet(true);
  }
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (!isSetAggregate_functions()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'aggregate_functions' is unset! Struct:" + toString());
    }
    ...
    if (!isSetNeed_finalize()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'need_finalize' is unset! Struct:" + toString());
    }

    if (!isSetUse_streaming_preaggregation()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'use_streaming_preaggregation' is unset! Struct:" + toString());
    }
