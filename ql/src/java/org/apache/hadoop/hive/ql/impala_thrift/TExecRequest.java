...
public class TExecRequest implements org.apache.thrift.TBase<TExecRequest, TExecRequest._Fields>, java.io.Serializable, Cloneable, Comparable<TExecRequest> {
  ...
  private org.apache.impala.thrift.TStmtType stmt_type; // required
  private org.apache.impala.thrift.TQueryOptions query_options; // required
  private TQueryExecRequest query_exec_request; // optional
  private TCatalogOpRequest catalog_op_request; // optional
  private org.apache.impala.thrift.TResultSetMetadata result_set_metadata; // optional
  private TExplainResult explain_result; // optional
  private TLoadDataReq load_data_request; // optional
  private List<TAccessEvent> access_events; // optional
  private List<String> analysis_warnings; // required
  private TSetQueryOptionRequest set_query_option_request; // optional
  private org.apache.impala.thrift.TEventSequence timeline; // optional
  private boolean user_has_profile_access; // optional
  private TAdminRequest admin_request; // optional
  private org.apache.impala.thrift.TRuntimeProfileNode profile; // optional
  private String testcase_data_path; // optional
   ...
   * @see org.apache.impala.thrift.TStmtType
   */
  public void setStmt_type(org.apache.impala.thrift.TStmtType stmt_type) {
    this.stmt_type = stmt_type;
  }
  ...
  public void setQuery_options(org.apache.impala.thrift.TQueryOptions query_options) {
    this.query_options = query_options;
  }
  ...
  public void setQuery_exec_request(TQueryExecRequest query_exec_request) {
  ...
  public void setCatalog_op_request(TCatalogOpRequest catalog_op_request) {
  ...
  public void setResult_set_metadata(org.apache.impala.thrift.TResultSetMetadata result_set_metadata) {
  ...
  public void setExplain_result(TExplainResult explain_result) {
  ...
  public void setLoad_data_request(TLoadDataReq load_data_request) {
  ...
  public void setAccess_events(List<TAccessEvent> access_events) {
  ...
  public void setAnalysis_warnings(List<String> analysis_warnings) {
    this.analysis_warnings = analysis_warnings;
  }
  ...
  public void setSet_query_option_request(TSetQueryOptionRequest set_query_option_request) {
  ...
  public void setTimeline(org.apache.impala.thrift.TEventSequence timeline) {
  ...
  public void setUser_has_profile_access(boolean user_has_profile_access) {
  ...
  public void setAdmin_request(TAdminRequest admin_request) {
  ...
  public void setProfile(org.apache.impala.thrift.TRuntimeProfileNode profile) {
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (!isSetStmt_type()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'stmt_type' is unset! Struct:" + toString());
    }

    if (!isSetQuery_options()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'query_options' is unset! Struct:" + toString());
    }

    if (!isSetAnalysis_warnings()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'analysis_warnings' is unset! Struct:" + toString());
    }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.access_events = new ArrayList<TAccessEvent>(_list170.size);
                TAccessEvent _elem171;
                for (int _i172 = 0; _i172 < _list170.size; ++_i172)
                {
                  _elem171 = new TAccessEvent();
                  _elem171.read(iprot);
                  struct.access_events.add(_elem171);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.analysis_warnings = new ArrayList<String>(_list173.size);
                String _elem174;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, TExecRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.access_events != null) {
        if (struct.isSetAccess_events()) {
          oprot.writeFieldBegin(ACCESS_EVENTS_FIELD_DESC);
          {
            ...
            for (TAccessEvent _iter176 : struct.access_events)
            {
      ...
      if (struct.analysis_warnings != null) {
        oprot.writeFieldBegin(ANALYSIS_WARNINGS_FIELD_DESC);
        {
          ...
          for (String _iter177 : struct.analysis_warnings)
          {
  ...
  private static class TExecRequestTupleScheme extends TupleScheme<TExecRequest> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, TExecRequest struct) throws org.apache.thrift.TException {
      ...
      struct.query_options.write(oprot);
      {
        ...
        for (String _iter178 : struct.analysis_warnings)
        {
      ...
      if (struct.isSetAccess_events()) {
        {
          ...
          for (TAccessEvent _iter179 : struct.access_events)
          {
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, TExecRequest struct) throws org.apache.thrift.TException {
      ...
      struct.setQuery_optionsIsSet(true);
      {
        ...
        struct.analysis_warnings = new ArrayList<String>(_list180.size);
        String _elem181;
        for (int _i182 = 0; _i182 < _list180.size; ++_i182)
        {
          _elem181 = iprot.readString();
          struct.analysis_warnings.add(_elem181);
        }
      }
      struct.setAnalysis_warningsIsSet(true);
      ...
      if (incoming.get(5)) {
        {
          ...
          struct.access_events = new ArrayList<TAccessEvent>(_list183.size);
          TAccessEvent _elem184;
          for (int _i185 = 0; _i185 < _list183.size; ++_i185)
          {
            _elem184 = new TAccessEvent();
            _elem184.read(iprot);
            struct.access_events.add(_elem184);
          }
        }
        struct.setAccess_eventsIsSet(true);
      }
