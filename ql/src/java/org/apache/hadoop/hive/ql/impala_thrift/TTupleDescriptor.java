...
public class TTupleDescriptor implements org.apache.thrift.TBase<TTupleDescriptor, TTupleDescriptor._Fields>, java.io.Serializable, Cloneable, Comparable<TTupleDescriptor> {
  ...
  private int byteSize; // required
  private int numNullBytes; // required
  private int tableId; // optional
  private List<Integer> tuplePath; // optional
  ...
  public void setNumNullBytes(int numNullBytes) {
    this.numNullBytes = numNullBytes;
    setNumNullBytesIsSet(true);
  }
  ...
  public void setTuplePath(List<Integer> tuplePath) {
  ...
  public void validate() throws org.apache.thrift.TException {
    ...
    if (!isSetByteSize()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'byteSize' is unset! Struct:" + toString());
    }

    if (!isSetNumNullBytes()) {
      throw new org.apache.thrift.protocol.TProtocolException("Required field 'numNullBytes' is unset! Struct:" + toString());
    }
