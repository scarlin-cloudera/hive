...
public class TComputeStatsParams implements org.apache.thrift.TBase<TComputeStatsParams, TComputeStatsParams._Fields>, java.io.Serializable, Cloneable, Comparable<TComputeStatsParams> {
  ...
  private String tbl_stats_query; // optional
  private String col_stats_query; // optional
  private boolean is_incremental; // optional
  private List<org.apache.impala.thrift.TPartitionStats> existing_part_stats; // optional
  private List<List<String>> expected_partitions; // optional
  private boolean expect_all_partitions; // optional
  private int num_partition_cols; // optional
  ...
  public void setTbl_stats_query(String tbl_stats_query) {
  ...
  public void setCol_stats_query(String col_stats_query) {
  ...
  public void setExisting_part_stats(List<org.apache.impala.thrift.TPartitionStats> existing_part_stats) {
  ...
  public void setExpected_partitions(List<List<String>> expected_partitions) {
  ...
  public void setNum_partition_cols(int num_partition_cols) {
