...
public class ImpalaHiveServer2Service {
  ...
  public interface Iface extends org.apache.hive.service.rpc.thrift.TCLIService.Iface {
    ...
    public org.apache.hive.service.rpc.thrift.TExecuteStatementResp ExecutePlannedStatement(TExecutePlannedStatementReq req) throws org.apache.thrift.TException;
  ...
  public interface AsyncIface extends org.apache.hive.service.rpc.thrift.TCLIService .AsyncIface {
    ...
    public void ExecutePlannedStatement(TExecutePlannedStatementReq req, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.hive.service.rpc.thrift.TCLIService.Client implements Iface {
    ...
    public void send_ExecutePlannedStatement(TExecutePlannedStatementReq req) throws org.apache.thrift.TException
    {
      ExecutePlannedStatement_args args = new ExecutePlannedStatement_args();
      args.setReq(req);
      sendBase("ExecutePlannedStatement", args);
    }

    public org.apache.hive.service.rpc.thrift.TExecuteStatementResp recv_ExecutePlannedStatement() throws org.apache.thrift.TException
    {
      ExecutePlannedStatement_result result = new ExecutePlannedStatement_result();
      receiveBase(result, "ExecutePlannedStatement");
      if (result.isSetSuccess()) {
        return result.success;
      }
      throw new org.apache.thrift.TApplicationException(org.apache.thrift.TApplicationException.MISSING_RESULT, "ExecutePlannedStatement failed: unknown result");
    }
  ...
  public static class AsyncClient extends org.apache.hive.service.rpc.thrift.TCLIService.AsyncClient implements AsyncIface {
    ...
    public void ExecutePlannedStatement(TExecutePlannedStatementReq req, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      ExecutePlannedStatement_call method_call = new ExecutePlannedStatement_call(req, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class ExecutePlannedStatement_call extends org.apache.thrift.async.TAsyncMethodCall {
      private TExecutePlannedStatementReq req;
      public ExecutePlannedStatement_call(TExecutePlannedStatementReq req, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.req = req;
      }

      public void write_args(org.apache.thrift.protocol.TProtocol prot) throws org.apache.thrift.TException {
        prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage("ExecutePlannedStatement", org.apache.thrift.protocol.TMessageType.CALL, 0));
        ExecutePlannedStatement_args args = new ExecutePlannedStatement_args();
        args.setReq(req);
        args.write(prot);
        prot.writeMessageEnd();
      ...
      public org.apache.hive.service.rpc.thrift.TExecuteStatementResp getResult() throws org.apache.thrift.TException {
        ...
        org.apache.thrift.transport.TMemoryInputTransport memoryTransport = new org.apache.thrift.transport.TMemoryInputTransport(getFrameBuffer().array());
        org.apache.thrift.protocol.TProtocol prot = client.getProtocolFactory().getProtocol(memoryTransport);
        return (new Client(prot)).recv_ExecutePlannedStatement();
      }
    }
  ...
  public static class Processor<I extends Iface> extends org.apache.hive.service.rpc.thrift.TCLIService.Processor<I> implements org.apache.thrift.TProcessor {
    ...
    private static <I extends Iface> Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> getProcessMap(Map<String,  org.apache.thrift.ProcessFunction<I, ? extends  org.apache.thrift.TBase>> processMap) {
      ...
      processMap.put("ExecutePlannedStatement", new ExecutePlannedStatement());
      return processMap;
    }
    ...
    public static class ExecutePlannedStatement<I extends Iface> extends org.apache.thrift.ProcessFunction<I, ExecutePlannedStatement_args> {
      public ExecutePlannedStatement() {
        super("ExecutePlannedStatement");
      }

      public ExecutePlannedStatement_args getEmptyArgsInstance() {
      ...
      public ExecutePlannedStatement_result getResult(I iface, ExecutePlannedStatement_args args) throws org.apache.thrift.TException {
        ExecutePlannedStatement_result result = new ExecutePlannedStatement_result();
        result.success = iface.ExecutePlannedStatement(args.req);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.hive.service.rpc.thrift.TCLIService.AsyncProcessor<I> {
    ...
    public static class ExecutePlannedStatement<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, ExecutePlannedStatement_args, org.apache.hive.service.rpc.thrift.TExecuteStatementResp> {
      public ExecutePlannedStatement() {
        super("ExecutePlannedStatement");
      }
      ...
      public void start(I iface, ExecutePlannedStatement_args args, org.apache.thrift.async.AsyncMethodCallback<org.apache.hive.service.rpc.thrift.TExecuteStatementResp> resultHandler) throws TException {
        iface.ExecutePlannedStatement(args.req,resultHandler);
      }
    }
  ...
  public static class ExecutePlannedStatement_args implements org.apache.thrift.TBase<ExecutePlannedStatement_args, ExecutePlannedStatement_args._Fields>, java.io.Serializable, Cloneable, Comparable<ExecutePlannedStatement_args>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ExecutePlannedStatement_args");

    private static final org.apache.thrift.protocol.TField REQ_FIELD_DESC = new org.apache.thrift.protocol.TField("req", org.apache.thrift.protocol.TType.STRUCT, (short)1);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new ExecutePlannedStatement_argsStandardSchemeFactory());
      schemes.put(TupleScheme.class, new ExecutePlannedStatement_argsTupleSchemeFactory());
    }

    public TExecutePlannedStatementReq req; // required
    ...
    static {
      Map<_Fields, org.apache.thrift.meta_data.FieldMetaData> tmpMap = new EnumMap<_Fields, org.apache.thrift.meta_data.FieldMetaData>(_Fields.class);
      tmpMap.put(_Fields.REQ, new org.apache.thrift.meta_data.FieldMetaData("req", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, TExecutePlannedStatementReq.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ExecutePlannedStatement_args.class, metaDataMap);
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public ExecutePlannedStatement_args(ExecutePlannedStatement_args other) {
      if (other.isSetReq()) {
        this.req = new TExecutePlannedStatementReq(other.req);
      }
    }

    public ExecutePlannedStatement_args deepCopy() {
    ...
    public ExecutePlannedStatement_args setReq(TExecutePlannedStatementReq req) {
      this.req = req;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case REQ:
        if (value == null) {
          ...
          setReq((TExecutePlannedStatementReq)value);
        }
        break;
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof ExecutePlannedStatement_args)
        return this.equals((ExecutePlannedStatement_args)that);
      return false;
    }

    public boolean equals(ExecutePlannedStatement_args that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(ExecutePlannedStatement_args other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    private static class ExecutePlannedStatement_argsStandardSchemeFactory implements SchemeFactory {
      public ExecutePlannedStatement_argsStandardScheme getScheme() {
        return new ExecutePlannedStatement_argsStandardScheme();
      }
    }

    private static class ExecutePlannedStatement_argsStandardScheme extends StandardScheme<ExecutePlannedStatement_args> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, ExecutePlannedStatement_args struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 1: // REQ
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.req = new TExecutePlannedStatementReq();
                struct.req.read(iprot);
                struct.setReqIsSet(true);
              } else { 
                org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, ExecutePlannedStatement_args struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class ExecutePlannedStatement_argsTupleSchemeFactory implements SchemeFactory {
      public ExecutePlannedStatement_argsTupleScheme getScheme() {
        return new ExecutePlannedStatement_argsTupleScheme();
      }
    }

    private static class ExecutePlannedStatement_argsTupleScheme extends TupleScheme<ExecutePlannedStatement_args> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, ExecutePlannedStatement_args struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetReq()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, ExecutePlannedStatement_args struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.req = new TExecutePlannedStatementReq();
  ...
  public static class ExecutePlannedStatement_result implements org.apache.thrift.TBase<ExecutePlannedStatement_result, ExecutePlannedStatement_result._Fields>, java.io.Serializable, Cloneable, Comparable<ExecutePlannedStatement_result>   {
    private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("ExecutePlannedStatement_result");

    private static final org.apache.thrift.protocol.TField SUCCESS_FIELD_DESC = new org.apache.thrift.protocol.TField("success", org.apache.thrift.protocol.TType.STRUCT, (short)0);

    private static final Map<Class<? extends IScheme>, SchemeFactory> schemes = new HashMap<Class<? extends IScheme>, SchemeFactory>();
    static {
      schemes.put(StandardScheme.class, new ExecutePlannedStatement_resultStandardSchemeFactory());
      schemes.put(TupleScheme.class, new ExecutePlannedStatement_resultTupleSchemeFactory());
    }

    public org.apache.hive.service.rpc.thrift.TExecuteStatementResp success; // required
    ...
    static {
      ...
      metaDataMap = Collections.unmodifiableMap(tmpMap);
      org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(ExecutePlannedStatement_result.class, metaDataMap);
    }
     ...
     * Performs a deep copy on <i>other</i>.
     */
    public ExecutePlannedStatement_result(ExecutePlannedStatement_result other) {
      if (other.isSetSuccess()) {
        this.success = new org.apache.hive.service.rpc.thrift.TExecuteStatementResp(other.success);
      }
    }

    public ExecutePlannedStatement_result deepCopy() {
    ...
    public ExecutePlannedStatement_result setSuccess(org.apache.hive.service.rpc.thrift.TExecuteStatementResp success) {
      this.success = success;
      return this;
    }
    ...
    public boolean equals(Object that) {
      if (that == null)
        return false;
      if (that instanceof ExecutePlannedStatement_result)
        return this.equals((ExecutePlannedStatement_result)that);
      return false;
    }

    public boolean equals(ExecutePlannedStatement_result that) {
      if (that == null)
        return false;
    ...
    @Override
    public int compareTo(ExecutePlannedStatement_result other) {
      if (!getClass().equals(other.getClass())) {
        return getClass().getName().compareTo(other.getClass().getName());
      }
    ...
    private static class ExecutePlannedStatement_resultStandardSchemeFactory implements SchemeFactory {
      public ExecutePlannedStatement_resultStandardScheme getScheme() {
        return new ExecutePlannedStatement_resultStandardScheme();
      }
    }

    private static class ExecutePlannedStatement_resultStandardScheme extends StandardScheme<ExecutePlannedStatement_result> {

      public void read(org.apache.thrift.protocol.TProtocol iprot, ExecutePlannedStatement_result struct) throws org.apache.thrift.TException {
        org.apache.thrift.protocol.TField schemeField;
        iprot.readStructBegin();
        while (true)
        {
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, ExecutePlannedStatement_result struct) throws org.apache.thrift.TException {
        struct.validate();
    ...
    private static class ExecutePlannedStatement_resultTupleSchemeFactory implements SchemeFactory {
      public ExecutePlannedStatement_resultTupleScheme getScheme() {
        return new ExecutePlannedStatement_resultTupleScheme();
      }
    }

    private static class ExecutePlannedStatement_resultTupleScheme extends TupleScheme<ExecutePlannedStatement_result> {

      @Override
      public void write(org.apache.thrift.protocol.TProtocol prot, ExecutePlannedStatement_result struct) throws org.apache.thrift.TException {
        TTupleProtocol oprot = (TTupleProtocol) prot;
        BitSet optionals = new BitSet();
        if (struct.isSetSuccess()) {
          optionals.set(0);
      ...
      @Override
      public void read(org.apache.thrift.protocol.TProtocol prot, ExecutePlannedStatement_result struct) throws org.apache.thrift.TException {
        TTupleProtocol iprot = (TTupleProtocol) prot;
        BitSet incoming = iprot.readBitSet(1);
        if (incoming.get(0)) {
          struct.success = new org.apache.hive.service.rpc.thrift.TExecuteStatementResp();
